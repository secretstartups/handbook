...
- Once you have reviewed and validated: 
  ...
  2. Request Manager Approval to `Restore Compute Minutes as an act of goodwill` to the [#spt_managers](https://gitlab.slack.com/archives/C01F9S37AKT) channel in Slack 
  3. MANAGERS: Acknowledge in Slack and post approval via internal note in the ticket. 
  4. Once Approval provided in ticket, restore the compute minutes using the [mechanizer zendesk app: Set compute minutes to namespace workflow](https://about.gitlab.com/handbook/support/license-and-renewals/workflows/customersdot/mechanizer.html#set-compute-minutes-to-namespace)
...
To transfer compute minutes from a user's personal namespace to a group namespace, use the [Force Association option in the ZD Mechanizer App](../mechanizer.html#force-associate).
...
Use the [Enable compute minutes via ZD Mechanizer app](../mechanizer.html#enable-units-of-compute).
