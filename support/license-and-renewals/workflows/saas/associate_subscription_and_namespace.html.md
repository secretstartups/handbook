...
1. Verify that the **new** subscription is for **a plan with seats**. If it is for CI minutes or other consumption, STOP and review the CI purchases to ensure we don't overwrite and lose their existing CI minutes (this can be done by an L&R expert).
