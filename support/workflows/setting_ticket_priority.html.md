...
Everyone is responsible for setting priority during ticket [triage](/handbook/support/workflows/meeting-frt-sla.html#taking-action-on-needs-org-tickets-triaging). If it comes to pass that a ticket has an incorrect priority, feel free to reset the priority.
