...
description: "Meeting Support SLAs with Response Crew and Hawk roles"
...
1. AMER and EMEA: [Support Response Crew](#support-response-crew)
1. APAC: [First Response Time Hawk](#first-response-time-hawk) and [SLA Hawk](#sla-hawk)
...
1. Send a reply to the customer (see FAQ below for tips on how to send a quick initial reply and then work on the ticket later)
   ...
   1. **Assign the ticket to yourself** when sending the first reply. You can always reassign later in the ticket's life. If the ticket has a preferred region outside of your region or you're taking PTO following your crew day, CC yourself on tickets you send during your crew shift. Doing so will keep you updated on the ticket progress while giving others the option to assign the ticket to themsselves.
