...
1. The triaging engineer should assign the ticket to themselves and review the initial provided information. US engineers should retain assignment of the ticket or discuss issue with management if they have any concerns, whilst EMEA engineers should consult the [EMEA Live Upgrade Assistance Request Tracker](https://gitlab.com/gitlab-com/support/support-team-meta/-/issues/3562) and APAC engineers should consult the
