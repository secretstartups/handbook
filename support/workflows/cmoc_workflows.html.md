...
1. Stage 1: **Incident Creation** - During this stage we're creating the actual incident in Status.io, linking up with Reliability via *The Situation Room* Zoom call, and notifying the Community Relations team, if necessary.
...
1. Notify the Community Relations team.
