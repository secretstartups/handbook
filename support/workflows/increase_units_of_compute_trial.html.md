...
title: Handling Requests for More Premium Trial units of compute
...
1. Confirm the namespace that is under a Trial subscription account.
   Note: units of compute should reflect 400 minutes.
...
For more details on adding more minutes to an account, see [Adding additional units of compute](https://about.gitlab.com/handbook/support/license-and-renewals/workflows/saas/ci_minutes.html).
