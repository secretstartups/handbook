...
| Reset max seats for QSR | This entry would be used after [approval to waive the overage](/handbook/sales/field-operations/order-processing/#waived-true-ups-policy-and-approval-requirements) has been granted and approved via SFDC chatter. Once that is done, you would file the form to request support reset the max seats |
