...
* **When the team member becomes a parent, send your team member a flower arrangement to congratulate them!** You can leverage the gift/flower process outlined [here](https://about.gitlab.com/handbook/people-group/#gifts--flowers) on the People group page managed by the the People Experience Associates. Keep in mind that your team member might be staying in the hospital for some time to recover, so pick a delivery date in the future when they are more likely to be home. 
...
* Consider participating in the [Your 4th Trimester program](https://about.gitlab.com/handbook/total-rewards/benefits/general-and-entity-benefits/#tuition-reimbursement-for-your-4th-trimester), a 90-day coaching program to help parents transition back to work.
