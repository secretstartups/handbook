...
canonical_path: "/company/culture/all-remote/phases-of-remote-adaptation/"
...
The amount of disruption is generally tied to two maturity factors: [culture](/company/culture/all-remote/building-culture/) and tools.
...
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/ZTcj1nhGmfw" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
Organizations in Phase 1 will attempt to copy the in-office environment and paste it into a digital, remote environment. [Replicating the in-office experience](/company/culture/all-remote/what-not-to-do/), remotely, is a telltale sign that an entity is in Phase 1 of remote adaptation. Here's how Sid Sijbrandij, GitLab CEO and co-founder, explains it: 
...
Learn more in GitLab's [guide to remote collaboration and whiteboarding](/company/culture/all-remote/collaboration-and-whiteboarding/).
...
Maximally efficient remote environments will do as little *work* as possible synchronously, instead focusing the valuable moments where two or more people are online at the same time on *[informal communication and bonding](/company/culture/all-remote/informal-communication/)*.
...
* Work [handbook-first](/company/culture/all-remote/handbook-first-documentation/), thereby documenting protocols, updates, solutions, or guidance in a single source of truth *first*. Only after documentation occurs should dissemination occur, creating a culture where [answering with a link](/company/culture/all-remote/self-service/#answer-with-a-link) is expected.
* Instead of simply having stacks of unsorted issues, you categorize in a systematic way using roadmaps and milestones.
* Expire your chat (Slack or Teams) messages [after 90 days](/company/culture/all-remote/how-to-work-remote-first/#expire-your-slack-or-teams-messages-after-90-days), creating a forcing function to only use Slack for informal communication, thereby creating a saner and [healthier](/company/culture/all-remote/mental-health/) atmosphere.

Learn more in GitLab's guide to using [forcing functions to work remote-first](/company/culture/all-remote/how-to-work-remote-first/).

<!-- blank line -->
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/CZ4nBzxPjNc?start=329" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
> We [expire](/company/culture/all-remote/how-to-work-remote-first/#expire-your-slack-or-teams-messages-after-90-days) all of our Slack messages after 90 days. So, nothing on Slack can be queried after 90 days. This serves as a [forcing function](/company/culture/all-remote/how-to-work-remote-first/) for all work to begin where it needs to end up, which is in GitLab.
>
...
>
> This counteracts the human instinct to start a project in a chat tool. It forces us to ask a simple question: 'Where does the work need to end up?' (Answer: [GitLab](/stages-devops-lifecycle/))
>
...
Leadership can create a more humane atmosphere by leaning on a tool (or tools) that enable asynchronous workflows, thereby [reducing meetings](/company/culture/all-remote/meetings/) and creating more time for focused, deep work. [GitLab uses GitLab](/company/culture/all-remote/gitlab-for-remote/) to accomplish this.
...
* Create [team building opportunities](/company/culture/all-remote/informal-communication/) that are even grander than those in colocated spaces, such as [team-wide talent shows](https://twitter.com/darrenmurph/status/1243194687453835265), trivia events, show-and-tell gatherings, virtual lobbies for water-cooler conversation, [global pizza parties/celebrations](/blog/2019/10/02/support-virtual-pizza-party/), and even global [family-oriented chats](/company/culture/all-remote/informal-communication/#juice-box-chats).
...
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/S197ok0lBtw?start=45" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
An organization's ability to transition quickly from Phase 1 to Phase 3 is dependent on maturity. Consider the below questions, all of which will be important for suddenly-remote firms forming a [remote leadership team](/company/culture/all-remote/remote-work-emergency-plan/#establish-a-remote-leadership-team).
...
* Does management default to creating a [single source of truth](/company/culture/all-remote/handbook-first-documentation/) for processes and protocols, or are FAQs and communiques created behind closed doors and only by executives?
...
* Does management seek to maximize the [advantages](/company/culture/all-remote/benefits/) of a remote environment once stabilization occurs?
