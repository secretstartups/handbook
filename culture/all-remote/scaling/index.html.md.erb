...
canonical_path: "/company/culture/all-remote/scaling/"
...
>
> There's very little benefit to colocation if you're such a big company. While the benefits of remote — [writing down your processes](/handbook/documentation/), stimulating cross-company [informal communication](/company/culture/all-remote/informal-communication/) — those get much more pronounced at scale.
>
...
Reducing headaches related to collaboration across time zones is not a problem which is unique or exclusive to remote. Because all-remote forces a company to lean heavily on [documentation](/company/culture/all-remote/management/#handbook-goals-and-documentation) of culture and process from the start, a fully remote organization can adapt to the addition of new team members in new time zones with greater poise. 

Too, colocated corporations which do not default to [asynchronous communication](/company/culture/all-remote/management/#asynchronous) in one office will likely struggle to operate in this manner when collaborating with colleages in a difference office. 
...
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/EuGsen3FxXc?start=640" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
>
> [Writing things down](/handbook/values/#write-things-down), [recording things](/handbook/marketing/marketing-operations/youtube/), and [working asynchronously](/company/culture/all-remote/management/#asynchronous) — we have to master those things early, so they become more prevalent in the organization. Hence, they are easier to scale.
>
> For example, we have the best [onboarding process](/company/culture/all-remote/learning-and-development/#how-do-you-onboard-new-team-members) of any company in the world. It's not perfect — I can see lots of room for improvement — but no other company has [250+ tasks](https://gitlab.com/gitlab-com/people-group/employment-templates/-/blob/main/.gitlab/issue_templates/onboarding.md#all-gitlabbers) you need to complete when onboarding.
>
...
By opening one's [hiring pipeline to the world](/company/culture/all-remote/hiring/), you're able to capture a more diverse array of applicants. You're also able to recruit individuals who may otherwise opt out of the workforce completely, such as stay-at-home parents, caregivers, and military spouses. 

By paying [local rates](/blog/2019/02/28/why-we-pay-local-rates/), an all-remote company can save money on hiring costs overall and hire more people. By removing the "Are you willing to relocate?" question from the interview process, hiring teams are able to focus on what actually matters: aptitude, drive, passion, empathy, and one's ability to add value to the company.
