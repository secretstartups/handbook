...
While success may look different to each individual, it requires support from one's organization, company-wide alignment on [values](/handbook/values/) that enable parents to feel empowered, and a [transparent atmosphere](/company/culture/all-remote/building-culture/) where advice may be shared.   

## Q: What are some work-from-home parenting jobs?

At GitLab, we believe that [most jobs can be done remotely](/company/culture/all-remote/terminology/). We are the world's largest all-remote company with no company-owned offices anywhere on the planet. We have team members in more than 65 countries, many of whom are parents. It can be done; it should be done!

When looking for a parent-friendly job, instead of focusing on the specific role, look at the company. Do they offer flexible scheduling? [No-ask PTO](/handbook/paid-time-off/#a-gitlab-team-members-guide-to-time-off)? Are they [family first](/handbook/values/#family-and-friends-first-work-second)? Choose an organization that proactively supports parents and prioritizing your kids above your job.

## Q: What are the benefits of work from home parenting?

While there are numerous [advantages to remote work](/company/culture/all-remote/benefits/), being able to pair working and parenting/caregiving is considered an enormous benefit to many people. 
...
1. Expectant parents have the autonomy to more easily plan around and attend doctor's appointments, optimize for their physical comfort during the day, and work [non-linear workdays](/company/culture/all-remote/non-linear-workday/) to build in rest when needed. 
...
* [combating isolation and burnout](/company/culture/all-remote/mental-health/#how-to-recognize-mental-health-struggles)
* [focus on mental health](/culture/all-remote/being-a-great-remote-manager/)
* [create healthy work/life balance](/company/culture/all-remote/mental-health/#rest-and-time-off-are-productive)
* [more working, less meeting](/company/culture/all-remote/meetings/#make-meeting-attendance-optional)
...
Parents bring a great deal of wisdom and experience to the workforce and contribute to a [diverse and inclusive culture](/company/culture/inclusion/building-diversity-and-inclusion/). No one should feel pressured to apologize for being a parent or [caregiver](/company/culture/all-remote/people/#caretakers). Instead, embrace the multiple roles you embody and take a few pointers from some of GitLab's employees who are both remote workers and parents/caregivers. 
...
1. It forces work to begin and end in GitLab ([the product](/company/culture/all-remote/gitlab-for-remote/))
...
Much of the [how to be a great remote manager](/company/culture/all-remote/being-a-great-remote-manager/) applies to any and all remote-work situations. However, a truly great manager is able to adapt to their employees' work/home/life situations and be willing to [iterate](/handbook/values/#iteration) accordingly.
...
From family time to unforgettable adventures, there are [many great stories](/company/culture/all-remote/stories/) of how remote work has impacted the lives of GitLab team members and their families around the world.
## Other resources
...
* [Crucial Conversations](https://about.gitlab.com/handbook/leadership/crucial-conversations/) video entitled `How Working Moms can Ask for Help at Home`
<!-- blank line -->
<figure class="video_container">
