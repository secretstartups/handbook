...
canonical_path: "/company/culture/all-remote/working-while-traveling/"
...
![A smartphone with tethering enabled is vital for digital nomads. Photo by Darren Murph](/images/all-remote/smartphone-tethering-laptop-dm.jpg){: .shadow.medium.center}
A smartphone with tethering enabled is vital for digital nomads. Photo by Darren Murph
{: .note.text-center}

For remote workers, a robust connection to the internet is [vital](/blog/2016/03/23/remote-communication/). This is easier to control at [home](/blog/2019/09/12/not-everyone-has-a-home-office/) or in a [coworking venue](/blog/2019/09/04/not-all-remote-is-created-equal/), and it requires special consideration when on the road. [Avid travelers](/blog/2019/06/25/how-remote-work-at-gitlab-enables-location-independence/) and dedicated [nomads](/company/culture/all-remote/people/#nomads) should maintain at least two connectivity sources — ideally, two sources that connect to different mobile networks. 
...
If you plan to travel through [various countries and continents](/blog/2017/06/30/there-and-back-again-in-one-release/), plan ahead. Services such as [KnowRoaming](https://www.knowroaming.co/order/) and [Skyroam](https://www.skyroam.com/) enable connections across borders. While it's possible to acquire a local SIM card in most countries, you'll need an unlocked smartphone or hotspot. Plus, you may need a basic understanding of the local language, local currency, and to shop during regular business hours. 
...
Consider where you plan to work on the road, and what elements of your [home workspace](/company/culture/all-remote/workspace/) you may miss. This will help you plan your purchases, should any be necessary.

Learn more about [traveling workspaces from the GitLab blog](/blog/2019/10/10/whats-in-your-backpack/). 

## RV/camping, long-term rentals, and couchsurfing

![Working from the ends of the earth is a major perk of all-remote. Photo by Darren Murph](/images/all-remote/gitlab-working-easter-island-dm.jpg){: .shadow.medium.center}
Working from the ends of the earth is a major perk of all-remote. Photo by Darren Murph
{: .note.text-center}

Being able to work from anywhere enables new lifestyle possibilities, including [extended road trips in an RV/camper](/blog/2019/06/25/how-remote-work-at-gitlab-enables-location-independence/). Those considering such a lifestyle should peruse online forums to understand the day-to-day demands, and take care to plot out your journey in way that doesn't leave you scrambling for a connection. 
