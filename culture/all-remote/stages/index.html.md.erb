...
This guide is a strategic resource for any company looking to solidify your remote or hybrid workplace design. If your workplace is transitioning to remote or hybrid, use this alongside our guide to the [phases of remote adaptation](/company/culture/all-remote/phases-of-remote-adaptation/) to create your transition plan.
...
For more, see GitLab's [guide to transitioning a company to remote work](https://about.gitlab.com/company/culture/all-remote/transition/).
...
However, job seekers should [inquire](/company/culture/all-remote/evaluate/) to what degree remote workers are supported in such environments. There is a marked difference between *allowing* remote and *supporting* remote. Some employers believe that remote employees are bypassing a commute, therefore no additional support is warranted.
...
There are many flavors of [hybrid-remote](/company/culture/all-remote/hybrid-remote/). The key attribute of a hybrid-remote arrangement is that *some* employees — but not all — are allowed to work remotely 100% of the time. These organizations have at least one physical office, and on any given day, a significant portion of the team physically commutes to that location.
...
However, hybrid-remote is a [tempting compromise that masks many downsides](https://about.gitlab.com/company/culture/all-remote/hybrid-remote/). In a hybrid-remote organization, leaders are forced to manage two fundamentally distinct ways of working. There is administrative burden to manage a default-onsite experience and a default-offsite experience, and some employees may choose to oscillate between the two. 
...
This approach may lead to stronger remote muscle being built, and [remote-first workflows](/company/culture/all-remote/how-to-work-remote-first/) used on remote days could become the default even on colocated days. The entire team is subject to a [forcing function](/company/culture/all-remote/how-to-work-remote-first/): on some workdays, office equipment and workflows just aren't an option.
...
Remote-first organizations optimize their workplaces for remote. They create documentation, policies, and [workflows](/company/culture/all-remote/how-to-work-remote-first/) that work when assuming that 100% of the organization is remote, even if some continue to occasionally visit a company-owned office.
...
"All-remote" describes organizations that do not maintain offices and work globally across many time zones. [GitLab is an all-remote company](/company/culture/all-remote/terminology/), with [team members](/company/team/) in 65+ countries. 
...
GitLab believes that the benefits of remote work outshine its challenges. Benefits include the ability to hire top-tier talent anywhere in the world; happier and more engaged team members; and societal impacts such as distribution of opportunity, increased diversity, and reduced traffic. There's plenty more: read our [guide to the benefits of remote work](/company/culture/all-remote/benefits/).

However, this does come with disadvantages. These may include loneliness, challenges with onboarding, difficulty building and maintaining culture, and breakdown of boundaries between work and life. Read our complete [guide to the drawbacks of remote work](/company/culture/all-remote/drawbacks/) for more detail.

## 10. Strictly remote

Taken to its extreme, a strictly remote company would never meet in person and never permit synchronous meetings. This seems impractical, and we are not yet aware of a company that adheres to this. If you are aware of any such company, please [create a merge request](/handbook/git-page-update/#13-edit-the-handbook) and assign to `@dmurph` to evaluate. 

## GitLab Remote Foundations Badge

To test your knowledge about remote work, consider taking the [GitLab Remote Foundations](https://gitlab.edcast.com/pathways/ECL-4d9840ae-0c56-4645-ad7b-452029b1e5bc) course in our learning experience platform to earn the **Remote Foundations** badge. This badge can be earned by _anyone_ who wants to learn about GitLab's approach to remote work.
