...
canonical_path: "/company/culture/all-remote/effective-communication/"
...
As an all-remote company that defaults to [asynchronous communication](/company/culture/all-remote/management/#asynchronous), GitLab relies heavily on textual communication. This can feel unusual or even uncomfortable for those who come from a colocated environment, where in-person meetings and vocalized communiques are the norm. Embracing text communication and learning to use it effectively requires a mental shift. Mastering this should be seen as a long-term project, though there are tips to breaking down barriers and experiencing benefits.
...
<blockquote class="twitter-tweet tw-align-center"><p lang="en" dir="ltr">1. Use Short Sentences<br><br>Keep your sentences, Kevin Hart short.<br><br>Amazon says under 30 words.<br><br>I’d say to keep them under 15 words.<br><br>This keeps them clear and concise with an emphasis on clarity. <a href="https://t.co/dQWiypgStx">pic.twitter.com/dQWiypgStx</a></p>&mdash; Alex Garcia 🔍 (@alexgarcia_atx) <a href="https://twitter.com/alexgarcia_atx/status/1439597358698807312?ref_src=twsrc%5Etfw">September 19, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
<!-- blank line -->
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/a9RNgt5u2MQ" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
[Say sorry](/handbook/values/#say-sorry) is an operating principle at GitLab. It's simple, yet powerful. Saying sorry via Slack or email, or a quick Zoom call if two parties are online at the same time, enables trust to be rebuilt. When using asynchronous collaboration tools such as [GitLab Issues and Merge Requests](/company/culture/all-remote/gitlab-for-remote/), feel welcome to reply atop your message if you feel that you may have written something offensive. This will send another email notification to those tagged, whereas an edit to your original message will not. 
...
Managers should strive to **incorporate positive feedback** into their day-to-day work. Particularly in an all-remote setting, where people can work for days, weeks, or months without seeing a colleague [in person](/company/culture/all-remote/in-person/), friendly words go a long way. 
...
![GitLab puzzle illustration](/images/all-remote/gitlab-review-and-collaborate.jpg){: .medium.center}
