...
| [Preprod](https://ops.gitlab.net/gitlab-org/quality/preprod/pipelines) | After [deployment to preprod](https://about.gitlab.com/handbook/engineering/infrastructure/environments/#pre) during Security and Patch releases | [`#qa-preprod`](https://gitlab.slack.com/archives/CR7QH0RV1) |
