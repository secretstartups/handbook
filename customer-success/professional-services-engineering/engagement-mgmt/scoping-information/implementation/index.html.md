...
Using the [services calculator](https://services-calculator.gitlab.io/), an SA/SAL/AE/TAM can create scoping issue to iterate and refine the services estimate for a customer. In this issue, we have included additional context to the Implementation Scoping Questions, which can ve previewed below
