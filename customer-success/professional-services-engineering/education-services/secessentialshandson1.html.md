...
1. In the left navigation pane, select **Security & Compliance > Vulnerability Report**. Looking at the **Scanner** column, you’ll see 1 problem found by SAST, 1 problem found by Secret Detection, and several problems found by DAST.
