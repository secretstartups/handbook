...
For transparency and awareness, the Troops activities specific to Solution Architects is listed below.
...
| Chorus call                                                  | Post Chorus call recordings to channel. Note: because these couple be a duplicate of an SA logged activity, these are excluded from reporting | Task: `Assigned To` had a Chorus Call with  Task: `Related To` (wf-09) | #troops-chorus-calls                              | `wf-09`   |
