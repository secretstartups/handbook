...
- **SA Validated Tech Evaluation Start Date** - The date the technical evaluation effectively started. The date does not mean the first SA engagement but designates the date a prospect or a customer has started or plans to start their Technical Evaluation.
