...
Product usage data (aka product telemetry data) is key to driving customer and GitLab outcomes by providing visibility to customers' adoption of licenses, use cases, and capabilities. For more about how we use and plan to use this data, please see our ["Product Usage Data" vision page](/handbook/customer-success/product-usage-vision/). 
