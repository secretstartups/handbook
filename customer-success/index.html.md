...
| **15** |  [PoV project kick-off](/handbook/sales/POV/) | Solutions Architect | Opportunity | Negotiating | Kick-off and proof of value execution plan catered to the customer |
| **16** | Initial introduction of TAM in preparation for close | Account Executive | Opportunity | Negotiating |
| **17** | Close with a technical win, negotiated terms and signed contract | GitLab Group | Opportunity | Closed Won | Contract, MSA, SLA, OLA, et al the other legal bits |
|  **18** | Official introduction and account management transition to TAM to customer stakeholders via [Welcome Call](https://docs.google.com/presentation/d/1RcMrN-TQxQt-tEaX1J2EcJATJQfBunStXGTjhGu8CDA/edit?usp=sharing) | Technical Account Manager | Opportunity | Closed Won |
...
| 13.1          |          | Jefferson Jones  | Solutions Architect       | Mid-Market West |
| 13.1          |          |                  |                           |                 |
