...
[Sitting at the intersection](/handbook/business-technology/data-team/#data-job-families) of [Data Analytics](https://about.gitlab.com/job-families/finance/data-analyst) and [Data Engineering](https://about.gitlab.com/job-families/finance/data-engineer), **Analytics Engineers** are responsible for translating data discovery, insights, and analysis needs into simple, efficient, and integrated data models and products, powered by the [Enterprise Data Platform](https://about.gitlab.com/handbook/business-technology/data-team/platform). Because their results are leveraged across all data teams at GitLab and in dozens of use cases, Analytics Engineers play a major role in the ability of an organization to scale its data program. The successful Analytics Engineer is able to blend business acumen with technical expertise and easily transition between business strategy and data development.
...
* Demonstrated experience with one or more of the following business subject areas: marketing, finance, sales, product, customer success, customer support
