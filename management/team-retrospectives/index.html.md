...
1. **When possible, all interested team members should be present.** No one should have to worry
   ...
   team (including stable counterparts such as those in product management, design, quality, support, and
   technical writing), where desirable - if someone's role or contributions are going to be
   discussed, they should have the opportunity to contribute to the
   retrospective as well.  This will allow for everyone who is contributing on a team to have an opportunity to
