...
*   **PIO Discount – **You can earn the largest available product discount with a **Partner Impacted Opportunity** . It can be a new opportunity to our sales team or one that was significantly impacted by the partner, early in the sales cycle.  It can be for a new or existing customer.  True ups and add-on licenses at renewal can also qualify for PIO discounts. The partner is expected to assist the GitLab Sales team in closing the sale.  
