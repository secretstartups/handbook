...
1. GitLab PTY NZ team members will get their salary on the 28th of each month, and they can access their payslip via [CloudPay's ESS portal](https://payroll.cloudpay.net/app/servlet/workflow?mode=ess). New hires will receive an invite to their email.
1. GitLab Ireland Ltd team members will get their salary on the 28th of every month unless it falls on a holiday then it will be the business day before, and team members can see their payslip via [CloudPay's ESS portal](https://payroll.cloudpay.net/app/servlet/workflow?mode=ess). New hires will receive an invite to their email.
