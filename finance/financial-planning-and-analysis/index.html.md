...
1. Manage the budget and planning processes for GitLab's [Board Plan](/finance/financial-planning-and-analysis/#annual-plan-and-target)
2. Build and maintain a [long-term financial model](/finance/financial-planning-and-analysis/#long-range-outlook) that identifies long-term strategy and financial targets
...
1. The second mechanism is the budget vs actual review to determine reasons for variances vs plan. See the section on [Variance Meeting with CFO](/finance/financial-planning-and-analysis/#variance-meeting-with-CFO)
 and [Variance Analysis](/finance/financial-planning-and-analysis/#variance-and-flux-analysis).
