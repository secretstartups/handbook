...
| Use Case | Pathway |
| ------ | ------ |
|  Customer renewal is taking longer than expected      | The sales AE (Account Executive) generates a one-off 21 day [temporary renewal extension](https://about.gitlab.com/handbook/product/fulfillment-guide/#temporary-renewal-extensions) via SFDC        |
