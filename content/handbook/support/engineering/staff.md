...
- Assist the team to meet [Support KPIs]({{< ref "/handbook/support/performance-indicators.md" >}}).
...
- See what [Support Managers are working on]({{< ref "/handbook/support/managers/_index.md#how-to-see-what-the-support-managers-are-working-on" >}}).
- Look over [Support (senior) leadership meeting notes]({{< ref "/handbook/support/managers/_index.md#support-leadership-meetings" >}}).
- Review [OKRs](../#okrs) and [KPIs]({{< ref "/handbook/support/performance-indicators.md" >}})
- [Current FY Direction]({{< ref "/handbook/support/_index.md#fy23-direction" >}})

## OKRs

Similar to [OKRs for Support Engineering Managers]({{< ref "/handbook/support/managers/_index.md#okrs" >}}), Staff Support Engineers can optionally work on [OKRs](https://about.gitlab.com/engineering/#engineering-okr-process).
...
1. Ideas for the OKR may come from any number of sources, including (but not limited to):
    - Proposed OKRs
    - [Support Direction]({{< ref "/handbook/support/_index.md#fy23-direction" >}})
