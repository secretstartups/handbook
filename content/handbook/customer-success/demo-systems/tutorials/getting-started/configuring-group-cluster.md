...
4. In the *Cluster credentials* pop-up modal window, **copy and paste each of the values to your text editor file**. For the value for the Cluster CA certificate, be sure to include the hyphen lines for `BEGIN CERTIFICATE` and `END CERTIFICATE`.
...
2. In the *Connect to the cluster* pop-up modal, click the **Run in Cloud Shell** button.
...
4. On the *Add a Kubernetes cluster integration* page, click the **Add existing cluster** tab.
