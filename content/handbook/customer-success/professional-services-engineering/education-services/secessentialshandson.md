...
> **We are transitioning to the latest version of this course.** You are using v16 if your group URL is `https://gitlab.com/gitlab-learn-labs/...`. If your group URL starts `https://spt.gitlabtraining.cloud`, please use the v15 instructions.
