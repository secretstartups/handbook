...
- [Success planning](https://about.gitlab.com/handbook/customer-success/csm/success-plans/) and uncovering strategic goals
...
- [Stage expansion](https://about.gitlab.com/handbook/customer-success/csm/stage-enablement-and-expansion/)
   - Secure
...
- Booking an [EBR](https://about.gitlab.com/handbook/customer-success/csm/ebr/)
...
- [Onboarding](https://about.gitlab.com/handbook/customer-success/csm/onboarding/)/customer kickoffs
   - Kickoff
...
These role-play scenarios are designed to practice identifying and gaining access to people in the listed [personas](https://about.gitlab.com/handbook/customer-success/csm/engagement#customer-personas).

#### Development Lead or Other Stakeholder

The defined persona for [somebody in a leadership role within the customer's development or engineering department](https://about.gitlab.com/handbook/customer-success/csm/engagement#development-lead).
...
The defined persona for [somebody responsible for a customer's application security](https://about.gitlab.com/handbook/customer-success/csm/engagement#software-security-lead).
...
Initial meeting between the CSM and an identified contact who is a [development lead persona](https://about.gitlab.com/handbook/customer-success/csm/engagement#development-lead).
