...
- Attributes - account-related details and links; for lifecycle stage definitions, see our [vision handbook page](https://about.gitlab.com/handbook/customer-success/vision/#lifecycle-stages), and for deployment types see our [definitions](https://about.gitlab.com/handbook/customer-success/csm/gainsight/deployment-types/)
- Scorecard - [health score](https://about.gitlab.com/handbook/customer-success/csm/health-score-triage/)
- Success Plan - [success plans](https://about.gitlab.com/handbook/customer-success/csm/success-plans/)
...
- Cockpit - holds all of your tasks and [CTAs](https://about.gitlab.com/handbook/customer-success/csm/gainsight/ctas/) for the account
- Contacts - all contacts for the account ([synced from Salesforce](https://about.gitlab.com/handbook/customer-success/csm/gainsight/#salesforce-and-zendesk-syncing))
- Zendesk Tickets - recent Zendesk tickets ([synced from Zendesk](https://about.gitlab.com/handbook/customer-success/csm/gainsight/#salesforce-and-zendesk-syncing))
- Subscriptions - GitLab subscription details ([synced from Salesforce](https://about.gitlab.com/handbook/customer-success/csm/gainsight/#salesforce-and-zendesk-syncing))
- Opportunities - open opportunities ([synced from Salesforce](https://about.gitlab.com/handbook/customer-success/csm/gainsight/#salesforce-and-zendesk-syncing))
- Salesforce Activities - "Activity History" section [from Salesforce](https://about.gitlab.com/handbook/customer-success/csm/gainsight/#salesforce-and-zendesk-syncing)
- License Utilization - [license utilization](https://about.gitlab.com/handbook/customer-success/product-usage-data/use-case-adoption/)
...
For information on customer surveys and how the NPS and CSAT scores are calculated and the types of questions asked, please refer to the [NPS and CSAT scores handbook page](https://about.gitlab.com/handbook/customer-success/csm/gainsight/c360-overview/nps-csat-scores).
