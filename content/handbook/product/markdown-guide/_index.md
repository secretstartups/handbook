...
This style guide is for [about.gitlab.com]. For styles in the [GitLab Handbook](https://handbook.gitlab.com/handbook/) see the [Handbook Markdown Guide](https://handbook.gitlab.com/docs/markdown-guide/). For styles in the GitLab UI, see the [GitLab Flavored Markdown documentation](https://docs.gitlab.com/ee/user/markdown.html).
