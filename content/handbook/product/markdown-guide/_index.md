...
The `about.gitlab.com` website was generated by [Middleman](https://middlemanapp.com/), a blog-aware Static Site Generator ([SSG](https://www.staticgen.com/)) widely used by web developers.
[Markup language](https://en.wikipedia.org/wiki/Markup_language) is part of the structure of any SSG. It is a system to write documents making them somehow
syntactically distinguishable from text. [Lightweight markup languages](https://en.wikipedia.org/wiki/Lightweight_markup_language) have a simplified and unobtrusive syntax,
...
[CommonMarker](https://github.com/gjtorikian/commonmarker). Here you can find the [markdown style guide](https://docs.gitlab.com/ee/user/markdown.html) for them.
...
`about.gitlab.com`, including handbook pages, website pages, blog posts and everything else within the project [www-gitlab-com](https://gitlab.com/gitlab-com/www-gitlab-com).
...
For our [Blog](https://about.gitlab.com/blog/), everything in this guide can be applied. Read through the [Blog Formatting Guidelines](/handbook/marketing/blog/#formatting-guidelines) for further information.
...
- If you hit **enter** between two lines, both lines will be joined into a single paragraph, which is called [wrapping text](https://about.gitlab.com/2016/10/11/wrapping-text/#do-wrap-it).
...
[table generator](http://www.tablesgenerator.com/html_tables) may be able to help you do this.
...
Yes, we can use fancy (free) [Font Awesome](https://fontawesome.com/search?m=free&o=r) icons too.
...
See live examples [on this post](https://about.gitlab.com/blog/2016/06/10/ssg-overview-gitlab-pages-part-2/), where the icons are used to illustrate the text.
...
we are making use of Bootstrap's [panel blocks](https://getbootstrap.com/components/#panels-alternatives) and [alert boxes](https://getbootstrap.com/components/#alerts).
...
default by [Bootstrap](http://getbootstrap.com/components/#alerts). If we want them in a different
...
GitLab Pages](http://www.slideshare.net/creatop/how-to-use-any-static-site-generator-with-gitlab-pages).  Copying the embed code and stripping everything
...
[StackEdit](https://stackedit.io/) is awesome too, you can work on a markdown file even if you're away from your computer,
...
- If you are confused about any markup that you've found in this file, you can check its [`raw` file](https://gitlab.com/gitlab-com/www-gitlab-com/-/raw/master/sites/handbook/source/handbook/markdown-guide/index.html.md) for reference,
