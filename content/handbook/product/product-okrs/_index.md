...
- **2 weeks** prior to the start to quarter:
     - Product EBAs create Product Division OKRs in GitLab and mention '@gl-product' (section, stage, and group product leads) to finalize KR drafts with their respective [Product Quad](https://about.gitlab.com/handbook/engineering/infrastructure/test-platform/quad-planning/)
