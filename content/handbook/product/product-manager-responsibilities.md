...
For all MRs, please apply `milestone` and labels `product operations` `product handbook` and `prodops:release` so your changes show up in the product handbook [updates page](/handbook/product/handbook-updates/). Please assign to [Product Operations](/handbook/company/team/#fseifoddini) to approve and merge. Product Operations will then add the [VP of Product](https://gitlab.com/david) and any other product team stakeholders as appropriate, as well as apply this **required** [approval flow](/handbook/hiring/job-families/#approval-flow), if necessary.
