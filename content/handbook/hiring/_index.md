...
{{% details "Greenhouse integrations you'll need" %}}
...
{{% details "Get your headcount assignments" %}}
...
{{% details "Open a req in Greenhouse" %}}
...
{{% details "Evergreen requisitions" %}}
...
{{% details "Post a job in Greenhouse" %}}
...
{{% details "Req access and permissions" %}}
...
{{% details "Set up scorecards and interview plans" %}}
...
{{% details "Scheduling tools in Greenhouse" %}}
...
{{% details "Greenhouse for internal candidates" %}}
...
{{% details "Candidate Hygiene" %}}
- {{% details "Merging candidates" %}}
...
- {{% details "Adding or transferring candidates between jobs" %}}
...
- {{% details "Common approval challenges" %}}
...
{{% details "PEO information and timelines" %}}
