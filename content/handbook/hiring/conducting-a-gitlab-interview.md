...
If you need to shadow interviews to complete their interview training issue, you reach out to the assigned recruiter for your department based on the [talent-acquisition alignment]({{< ref "recruiting-alignment" >}}).
...
Read about how to organize your calendar on the [Interviewer Calendar Maintenance]({{< ref "interviewing" >}}) page.
...
1. Ensure you've read the description of the role you're going to be interviewing candidates for. This can be found in the [job family page]({{< ref "./job-families" >}}).
...
1. Open up the [interview kit in Greenhouse]({{< ref "greenhouse#feedback-and-interview-kits" >}}). In the interview kit, you’ll be able to view the candidate’s resume, the description of the interview you’re expected to lead, the scorecard you’ll be evaluating the candidate against, and the suggested questions you ask during the interview.
...
1. Make sure you're up to date on our latest headcount, notable awards, messaging, and other facts about working at GitLab. Take a look at these [talent brand resources]({{< ref "employment-branding#talent-brand-resources" >}}) to help guide your conversation with candidates.
...
- Interview for soft skills. Really, do it! Pick some behavioral questions to get data on what the candidate has done before and how their behavior aligns with the [company values]({{< ref "values" >}}). We are all going to be much happier if we naturally agree on how things should be. You will be asked to evaluate how the candidate's values align with our own in your feedback form, and asking behavioral questions is the best way to assess this.
...
- If a candidate discloses [outside project(s) or activity(ies)]({{< ref "contracts-probation-periods#steps-as-a-current-candidate-actively-engaged-in-the-hiring-process" >}}), please notify the Recruiter.
...
[Tips On How To Prepare For Your Technical Interview]({{< ref "customer-support-interviewing" >}})
...
1. Be mindful of the background of the candidate. Someone who knows 10 languages already (and some languages in particular, Perl for example) may pick up Ruby in a second if given the right chance. Don't assume that someone with a Java background will not be capable of moving to a different stack. Note that individual positions may have stricter requirements; the Backend Engineer position [requires Ruby experience]({{< ref "/job-families/engineering/backend-engineer" >}}), for example.
...
The bottom of the feedback form will ask for an overall recommendation on if you want to hire this person or not; please do leave a score for each candidate, and read our [handbook page discussing the scorecards and best practices]({{< ref "greenhouse#scorecards" >}}).
