...
If there is not a current job family, the recruiter is to guide the hiring manager to proceed to [‘create or review the Job Family’]({{< ref "/handbook/hiring/job-families" >}}). Hiring Managers should not wait on an approved requisition to begin this step.
...
The Hiring Manager will review the position description in the `/job-families` folder and update it, if needed. If there is no existing job family, they should follow the steps to [create a new job family]({{< ref "/handbook/hiring/job-families#job-families" >}}). A compensation benchmark for the role should be set by working with the Compensation & Benefits team.
...
1. Under `Employment Type`, select your opening type. *Contract* refers to a true consultant, who works on short-term projects, and not someone in a country like the Netherlands who requires a one-year contract before indefinite. Recruiters will typically not hire Contractors.
...
- Scroll to the `Who's responsible for this job?` to assign the Hiring Managers, [Recruiter(s)]({{< ref "recruiting-alignment" >}}), Coordinator(s) and Sourcer(s). Everyone who will be involved in interviewing may not be known until after the Kick-off Session.
