...
- CEO: Increased usage of idea to production. 100% growth
  ...
  - VP Eng: Make sure existing features are used by GitLab.com. Cycle time analytics working.
    ...
    - Edge: [Triage policies](https://about.gitlab.com/handbook/engineering/quality/issue-triage/) are [automatically enforced](https://gitlab.com/gitlab-issue-triage/issue-triage).
