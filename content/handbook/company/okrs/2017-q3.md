...
- CEO: Increase [average sales price (ASP)](/handbook/finance/#definitions) (IACV per won) by 25% QoQ
    ...
    - CMO: More sales assets. 3 new for each stage ([TOFU, MOFU, BOFU](https://about.gitlab.com/handbook/glossary/#funnel)) of the sales process => Miss. PMM hire/onboard.
...
- CEO: GitLab.com ready for mission-critical tasks. 99% of user requests have [first byte](https://about.gitlab.com/handbook/engineering/performance/#first-byte) < 1s
  ...
  - VP Scaling: [Lower latency](https://gitlab.com/gitlab-com/infrastructure/issues/2373). 99% of user requests have [first byte](https://about.gitlab.com/handbook/engineering/performance/#first-byte) < [1s](https://dashboards.gitlab.com/dashboard/db/transaction-overview?panelId=2&fullscreen&orgId=1)
    ...
    [SLO’s](https://about.gitlab.com/handbook/engineering/infrastructure/production/architecture/)
...
- CEO: Increased usage of idea to production. 100% growth
  ...
  - VP Eng: Make sure existing features are used by GitLab.com. Cycle time analytics working.
    ...
    - Edge: [Triage policies](https://about.gitlab.com/handbook/engineering/infrastructure/engineering-productivity/issue-triage/) are [automatically enforced](https://gitlab.com/gitlab-issue-triage/issue-triage).
