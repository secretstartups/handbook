...
1. Questions about our values [{{< ref "values" >}}]({{< ref "values" >}})
1. Team structure [{{< ref "structure" >}}]({{< ref "structure" >}}) or [organization chart](https://comp-calculator.gitlab.net/org_chart)
1. How we work [{{< ref "/handbook" >}}]({{< ref "/handbook" >}})
  - Please pay special attention to the guideline about developing content and procedures in a public, transparent, [handbook-first]({{< ref "/handbook" >}}) manner
...
All questions and answers during the call should be added to this page or to the relevant pages of [the handbook]({{< ref "/handbook" >}}). This is done during the call to immediately make any changes; for example we created [this commit](https://gitlab.com/gitlab-com/www-gitlab-com/commit/8cf1b0117dce5439f61e207315f75db96c917056) together on the call.
...
##### All previously asked questions have been integrated into our [handbook]({{< ref "/handbook" >}})
