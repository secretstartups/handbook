...
canonical_path: "/company/culture/all-remote/people/"
...
All-remote and remote-first organizations [enable lifestyles](/company/culture/all-remote/benefits/) that simply are not possible in colocated companies, where a daily commute and one's physical presence are required. 

When you're free to choose when and where you live and work, [your work can revolve around your life](/company/culture/all-remote/stories/) as opposed to the other way around. 

All-remote and remote-first [organizations](/company/culture/all-remote/jobs/) tend to attract people who place a high degree of value on [autonomy](/blog/2018/10/18/the-case-for-all-remote-companies/), [flexibility](/blog/2019/06/25/how-remote-work-at-gitlab-enables-location-independence/), [empathy](/blog/2019/07/09/tips-for-working-from-home-remote-work/), and [mobility](/company/culture/inclusion/#fully-distributed-and-completely-connected). It also presents [outsized opportunity for people who must live or prefer to live in rural areas](/blog/2019/08/15/all-remote-is-for-everyone/), where well-paying careers in technical industries are few and far between.

Below, we're detailing examples of people who have adopted a [remote lifestyle](/blog/2018/03/15/working-at-gitlab-affects-my-life/). If these resonate with you, chances are high that you would receive a great deal of fulfillment in an [all-remote or remote-first company](/company/culture/all-remote/jobs/). Similarly, if you're an employer yearning to hire sharp, driven, passionate people like the below, consider [going all-remote](/company/culture/all-remote/) in your own company.

## Nomads

<!-- blank line -->
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/amiDcpIXIQ8" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
The thought of having no permanent residence while maintaining the same career would conjure laughter and confusion a few decades ago. Thanks to rapid advancement in internet infrastructure, technology, software, tools, and cultural appreciation for [asynchronous communication](/company/culture/all-remote/informal-communication/), it's now quite [feasible](/company/culture/all-remote/jobs/). 

<blockquote class="twitter-tweet tw-align-center"><p lang="en" dir="ltr">Just over 2 years ago, I left my tax accounting career to write full-time for <a href="https://twitter.com/thepointsguy?ref_src=twsrc%5Etfw">@thepointsguy</a>. Since then, I&#39;ve flown quite a bit. Specifically, in the last 24 months, I have flown:<br>- 569,041 miles (289,797 in economy)<br>- 1,293 hours<br>- 298 flights on 246 routes<br>- 43 airlines <a href="https://t.co/c0hMqSnxVs">pic.twitter.com/c0hMqSnxVs</a></p>&mdash; JT Genter (@JTGenter) <a href="https://twitter.com/JTGenter/status/1051185813344669696?ref_src=twsrc%5Etfw">October 13, 2018</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
...
To see how two GitLab team members utilized the company's [Visiting Grant incentive](/handbook/incentives/#visiting-grant) to work with 49 different colleagues across 5 continents, have a look at "[Around the world in 6 releases](/blog/2017/01/31/around-the-world-in-6-releases/)."

## Travelers

Individuals with an [innate sense of wanderlust](/blog/2019/09/12/not-everyone-has-a-home-office/) are apt to gain fulfillment in an [all-remote or remote-first role](/company/culture/all-remote/jobs/). Having the freedom and flexibility to travel at will and [work from anywhere in the world](/blog/2019/06/25/how-remote-work-at-gitlab-enables-location-independence/) with a solid internet connection is a tremendous perk for those who don't want to sit still, yearn to explore new cultures, and collect new passport stamps. 
...
<!-- blank line -->
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/MZc0HazaX_4?start=382" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
Building a career while raising one or more children has its [challenges](/blog/2019/08/08/remote-kids-part-four/). However, all-remote and remote-first organizations provide an [atmopshere](/company/culture/all-remote/benefits/) where those who yearn to continue working may do so without the usual family sacrifices linked to daily commutes in colocated environments. 
...
While this provides clear and quantifiable [benefits](/company/culture/all-remote/mental-health/) to the family, it also creates an economic boost to the community in which they relocate to. 
...
All-remote is an ideal anecdote. Even as relocations occur, an all-remote team member can still contribute their insights and knowledge for the betterment of the company. This can create increased loyalty and lower turnover for all-remote employers, while supporting [hiring](/company/culture/all-remote/hiring/) pipelines which are [more diverse and inclusive](/company/culture/inclusion/#fully-distributed-and-completely-connected). 
...
It's wise to rank all of the above in order of importance for you. If you find that being able to live wherever you wish is as important, if not more important, than extracting a certain salary from a role, [all-remote will likely suit you well](/blog/2015/06/17/highlights-to-my-first-remote-job/). 

[Eldridge H.](https://gitlab.com/ehenley), a support engineer at GitLab, articulates this below.

> It dawned on me just how liberating remote work with GitLab is. It's a bit difficult to fully explain, but having my [own personal space](/company/culture/all-remote/workspace/) to work from is amazing. 
>
> Having my own personal environment to work in, and being able [to make this space my own](/blog/2019/09/12/not-everyone-has-a-home-office/), really motivates me to do well. The freedom I have to make choices on how I approach things and at the same time, being empowered to communicate with others and adapt their approaches is insanely thought provoking. 
>
> Even though [everyone is remote](/blog/2019/08/15/all-remote-is-for-everyone/), it's just like being in an office with everyone. It's so reassuring how motivated, caring, and diligent everyone is. It's insane how there are so many of us, but the whole process from ticket first response to resolution makes it seem like we are all in the same location. 
>
> It's so cool to be surrounded by extremely smart and motivated people. To be able to troubleshoot and talk about nerdy things without fear. It's reassuring to know that we all have the same goal in mind. The autonomy to [communicate](/blog/2019/12/23/six-key-practices-that-improve-communication/) with who we need to, in our own personal space, really shows me how valuable we are as a team. 
>
...
>
> I expected remote work to be [a hurdle to overcome](/blog/2019/12/30/mastering-the-all-remote-environment/) upon joining GitLab. I wondered how having the filter of a webcam would impact people and how they reacted or interacted. These questions were [squashed](/blog/2019/08/05/tips-for-mastering-video-calls/) after my first day. I am extremely happy to have been given this insane opportunity. To make things better for others and at the same time, make things better for myself. We are like an open source community *within* an open source community.


### Employer benefits

[Employers](/company/culture/all-remote/management/) should recognize that this reality [also benefits them](/company/culture/all-remote/compensation/). When you hire individuals who place a high degree of value on not having to commute and being able to live and work where they're most comfortable, they will generally hold the company in higher regard, find greater connection with their work, and exhibit greater loyalty. Research by [TINYpulse and Owl Labs](https://www.tinypulse.com/blog/the-state-of-remote-work) found that "companies that support remote work have a 25% higher retention rate than companies that don't." 

## Work/life harmony

<!-- blank line -->
<figure class="video_container">
  <iframe src="https://www.youtube.com/embed/2yN2vBxo7as" frameborder="0" allowfullscreen="true"> </iframe>
</figure>
<!-- blank line -->
...
A healthier approach, enabled by all-remote, is work/life *harmony*. When your work and your life are in harmony, there's less friction. You're free to approach your day not as a competition between two factions, but as [one experience with two forces that more naturally give and take as needed](/blog/2019/06/18/day-in-the-life-remote-worker/).

### Added adaptability

All-remote enables greater harmony by being more [forgiving of the unknown](/blog/2018/05/11/day-in-life-of-remote-sdr/), and more accepting of the unexpected. When you're able to live and work in a place of your choosing, there's one less barrier in the way when you need to quickly pivot away from work in order to address a situation at home, with family, etc. 
...
An added benefit to being a [manager of one](/handbook/values/#managers-of-one) and working in an environment that supports [asynchronous communication](/company/culture/all-remote/informal-communication/) is the ability to shift one's working day to accomodate important life moments. 
...
>  When we made the decision to relocate to help care for my dad, it was a huge relief to know I didn't have to worry about the move impacting my career. The asynchronous nature of our work also means I have the freedom to shape my days and weeks to prioritize time with my parents. Being part of the GitLab team gives me invaluable flexibility, support, and stability that benefits my entire family during this challenging chapter of life. - *[Betsy B., All-Remote Evangelist](/company/team/#bbula)*
