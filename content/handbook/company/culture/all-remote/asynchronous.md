...
| **Alternate times for recurring scheduled meetings**         | Synchronous meetings should be inclusive of those who want to attend and are in different time zones. For example, a team's recurring weekly meetings, alternate between a time which is ideal for [EMEA](https://about.gitlab.com/handbook/sales/territories/) and Eastern [AMER](https://about.gitlab.com/handbook/sales/territories/) (8:00AM Pacific) and a time ideal for [APAC](https://about.gitlab.com/handbook/sales/territories/) and Western [AMER](https://about.gitlab.com/handbook/sales/territories/) (3:00PM Pacific). |
