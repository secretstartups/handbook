...
1. As of 2022-05-01, we’ve created a Flexible PTO policy to better outline communication expectations for team members and managers. This means that:
    ...
    - Note that your manager is required to ensure that your PTO does not impact business results and as such may request that you modify your dates when necessary.
    ...
    - At GitLab, team members are required to enter all days away (Eg PTO, Public holidays, F&F, bereavement etc) in [Time Off by Deel](#time-off-by-deel) as it will create an event, capture your out-of-office dates in Workday, and notify your manager..
