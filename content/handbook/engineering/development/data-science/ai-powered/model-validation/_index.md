...
3. If a feature team finds bugs that impact their ability to use the framework, here is a [template](https://gitlab.com/gitlab-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/blob/main/.gitlab/issue_templates/Default.md?ref_type=heads) to request a fix in a [new issue](https://gitlab.com/gitlab-org/modelops/ai-model-validation-and-research/ai-evaluation/prompt-library/-/issues/new?issuable_template=Default). Additionally encourage to post on [#g_ai_model_validation](https://gitlab.enterprise.slack.com/archives/C05CJ1T3P0W)
