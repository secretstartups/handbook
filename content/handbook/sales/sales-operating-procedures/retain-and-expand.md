...
Once the account is won it is time for the AE/SAE/CSM/PSE to work together to ensure [Customer Success](https://about.gitlab.com/handbook/customer-success/). This requires [Account Engagement](https://about.gitlab.com/handbook/customer-success/csm/engagement/) by all parties.  The components of this are:
...
4. Define transition process for customers. Plans should not end at signature but from their goal and work backwards
    - SAE/AE updates [Command Plan](https://about.gitlab.com/handbook/sales/command-of-the-message/command-plan/)
    - CSM builds the [Success Plan](https://about.gitlab.com/handbook/customer-success/csm/success-plans/)
...
### 2.1 [Success Planning](https://about.gitlab.com/handbook/customer-success/csm/success-plans/)
...
- CSM responsibilities include a full use-case, stakeholder, technology stack, and opportunity discovery with the account customer.  The information gathered for the customer’s success plan is housed in **[GainSight](https://about.gitlab.com/handbook/customer-success/csm/gainsight/)**, which is embedded as an additional link within Salesforce.
- CSM coordinates and educates customer and positions them for GitLab Certification with GitLab 101.

### 2.2 [Stage Adoption](https://about.gitlab.com/handbook/customer-success/csm/stage-adoption/)
...
- SAE/CSM continually re-verify and documents customer’s positive business outcomes and connects the GitLab solution with their pain.
    - [Success Plans](https://about.gitlab.com/handbook/customer-success/csm/success-plans/) for CSMs in GainSight
    - [Command Plan](https://about.gitlab.com/handbook/sales/command-of-the-message/command-plan/) for SAEs in Salesforce
...
- Update the [MEDDPPICC](https://about.gitlab.com/handbook/sales/meddppicc/) section of the [Command Plan](https://about.gitlab.com/handbook/sales/command-of-the-message/command-plan/) to ensure pretentant data is up-to-date and accurate
...
- [Account assignment](https://about.gitlab.com/handbook/customer-success/csm/csm-manager/#account-assignment): Accounts have been reviewed and are assigned or are in review
- [Customer Onboarding](https://about.gitlab.com/handbook/customer-success/csm/csm-manager/#onboarding-object-review): Customers in the Onboarding phase have been reviewed and onboarding status and notes are complete
- [Success Plans](https://about.gitlab.com/handbook/customer-success/csm/csm-manager/#success-plan-review): Customers have a Success Plan, it is being communicated with the customer, and the CSM is using it as the guiding document
- [Triage and Health](https://about.gitlab.com/handbook/customer-success/csm/csm-manager/#triage-and-health-review): Health for all CSM-assigned accounts have been updated within the last month, and any accounts in Triage are being evaluated
- [Renewal Review](https://about.gitlab.com/handbook/customer-success/csm/csm-manager/#renewal-review): Upcoming customer renewals have been reviewed — the CSM has updated customer health and communicated with the SAE and SA for the upcoming renewal
