...
1. Field team members are first trained on the [DevOps Technology Landscape](https://gitlabfieldenablement.s3.us-east-2.amazonaws.com/DevOps+Technology+Landscape+-+Storyline+output/story.html) during [Sales & Customer Success Onboarding](https://about.gitlab.com/handbook/sales/onboarding/)
1. New field team members are then trained on [customer value drivers](https://about.gitlab.com/handbook/sales/command-of-the-message/#customer-value-drivers) and [GitLab’s value-based messaging framework](https://about.gitlab.com/handbook/sales/command-of-the-message/) (also during onboarding)
...
1. Field team members will then be encouraged to complete [customer use case courses](https://about.gitlab.com/handbook/sales/training/field-certification/#gitlab-use-cases-overview) that focus on how to sell GitLab
