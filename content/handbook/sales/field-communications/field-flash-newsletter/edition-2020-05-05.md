...
ABM campaigns are now being launched on an ongoing basis. **Accounts that are in our ABM strategy will include the ‘GTM strategy’ field in Salesforce.** And, you can check out the new Demandbase section in Salesforce to [view intent](https://about.gitlab.com/handbook/marketing/account-based-marketing/) data for accounts. For more information:
- [ABM Handbook Page](https://about.gitlab.com/handbook/marketing/account-based-marketing/)
- [Nominating an account](https://about.gitlab.com/handbook/marketing/account-based-marketing/)
- [When will an account move?](https://about.gitlab.com/handbook/marketing/account-based-marketing/)
...
Questions? Reach out to #channel-ops or [visit the Handbook](https://about.gitlab.com/handbook/sales/field-operations/channel-operations/).
...
The GitLab Value Framework v1.1 is now available! This includes updates based on your feedback of [Command of the Message](https://about.gitlab.com/handbook/sales/command-of-the-message/). Have feedback you'd like to share for future iterations? Follow these steps.
...
The new Sales Standard Operating Procedures (SOP) page outlines in detail the process for phase two of the sales cycle: Facilitating the Opportunity. [Check it out -->](https://about.gitlab.com/handbook/sales/sales-operating-procedures/facilitate-the-opportunity/)

New videos from Bryan Beck, IT Agility Director at a large Fortune 500 energy company, give a firsthand view into what life is like for a team using a fragmented DevOps toolchain, among other helpful insights. [Watch the videos -->](https://about.gitlab.com/handbook/sales/it-agility-director-interview/#challenges-with-a-fragmented-devops-toolchain-approach)
