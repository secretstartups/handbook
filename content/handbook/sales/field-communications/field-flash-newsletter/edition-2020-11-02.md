...
----
Marketing has created **[two new target lists for both Large and Mid Market accounts](https://about.gitlab.com/handbook/marketing/account-based-marketing/) - GL4300 and MM4000 - that DemandGen, Field Marketing and Account Based Marketing will align efforts around**. The account lists are identified in Salesforce by the `GTM strategy Field` = `Account Centric` and `Account Based- Net New` tags. Both lists will be refreshed at the end of each quarter with the updated target account list available on day 1 of the new quarter.
...
Please [review the handbook for more details around the updates and process](https://about.gitlab.com/handbook/sales/field-operations/channel-operations/#policy-and-process). Reach out to the #channel-ops Slack channel with any questions.
...
![Rob-Nalen-TMS-Thumb](https://about.gitlab.com/handbook/sales/field-communications/field-flash-newsletter/images/Rob_Nalen_Thumb.png)
...
*See the [Field Flash Newsletter handbook page](https://about.gitlab.com/handbook/sales/field-communications/field-flash-newsletter/) for more information about this newsletter and copies of all past newsletters.*
