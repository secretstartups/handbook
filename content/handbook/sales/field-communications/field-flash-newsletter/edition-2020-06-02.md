...
----
We have **launched a new read-only Slack channel called #field-fyi** to help streamline important field-related news and announcements. ⭐️ Star this channel to stay up to date. ⭐️ Learn more about [how to use this channel](https://about.gitlab.com/handbook/sales/sales-google-groups/field-fyi-channel/) and see our updated [Communicating with the Field](https://about.gitlab.com/handbook/sales/sales-google-groups/) Handbook page for a full list of field Google Groups and Slack channels.
...
Watch the [6-minute Gainsight Overview video](https://www.youtube.com/watch?v=vXwsWB8zAXA&feature=youtu.be) and [learn more in the handbook](https://about.gitlab.com/handbook/customer-success/csm/gainsight/).
