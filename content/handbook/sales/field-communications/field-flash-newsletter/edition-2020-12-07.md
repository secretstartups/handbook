...
1. The [Channel Services Program](https://about.gitlab.com/handbook/resellers/services/) has launched to help new or existing partners design service portfolios around the DevOps Lifecycle in correlation to GitLab products.
1. We have created a robust [Channel Partner Training and Certification Program](https://about.gitlab.com/handbook/resellers/training/) to enable partners in our ecosystem to sell, market, service and support GitLab prospects and customers.
...
Learn more about our QBR ask prioritization process on the [QBR Handbook page](https://about.gitlab.com/handbook/sales/qbrs/#intake) and reach out to #sales-support with any questions.
...
![Timm-Ideker-TMS-Thumb](https://about.gitlab.com/handbook/sales/field-communications/field-flash-newsletter/images/TimmIdeker_TMS_thumb.png)
