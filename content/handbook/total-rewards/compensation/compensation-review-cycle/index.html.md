...
_**Note that all equity values provided are based on an assumed share price disclosed in the statement and may fluctuate throughout the year based on the current share price. Please review the additional disclaimers available in the statement.**_
