...
NetSuite Key Reports are indicated with the `KR:` prefix. _The following Key Reports need to be updated depending on the nature of the change request e.g. new department, new mapping, etc._
