...
#### How to Submit a Zip Request for a Contractor
          ...
          1. Before submitting a Zip request for a Contractor:
             ...
             1. If the Contractor requires access to GitLab [Orange or Red data](https://internal.gitlab.com/handbook/security/data_classification/), a [background screening]({{< ref "/handbook/people-policies#background-screenings" >}}) and subsequent Zip approval must be obtained from PeopleOps. Additionally, access to Orange or Red data requires [appropriate security measures]({{< ref "third-party-risk-management#independent-contractors" >}}) are in place. As such, a GitLab laptop must be issued followed by a Zip approval from IT Ops validating laptop issuance.
          ...
          *Contractors / Consultants that require Orange and Red Data access, that will be processed or stored outside GitLab's systems, are considered "Professional Services" and and are subject to a full security review. Please see the [Security Third Party Risk Management Handbook]({{< ref "third-party-risk-management" >}}) for more details.
...
{{% panel header="**TIPS to streamline approval process**" header-bg="primary" %}}
...
- Coupa Approval and Execute Contract: Once Coupa approvals are complete, Procurement will send any relevant contracts for signature via DocuSign; signatories are determined by GitLab’s [authorization matrix]({{< ref "authorization-matrix#authorization-matrix" >}}). Once the contract is fully executed by both parties, the procurement team will approve the Zip & Coupa Request, fully approving the Purchase Request and simultaneously releasing the Coupa Purchase Order (PO) to facilitate supplier payment.
...
If your request [requires negotiation](#-when-does-procurement-negotiate-my-contract-and-how-long-does-that-take), a [vendor security review]({{< ref "third-party-risk-management" >}}), and/or legal revisions, this will take longer as noted below.
...
- [Security Third Party Risk Management]({{< ref "third-party-risk-management" >}}) reviews are required for vendors that collect, process, or store Orange / Red Data, software providers (SaaS and On-premise), and independent contractors / consultants. (Excluding field marketing events)
...
1. Before sharing details and/or confidential information regarding GitLab business needs, obtain a [Mutual Non-Disclosure Agreement](https://drive.google.com/file/d/1kQfvcnJ_G-ljZKmBnAFbphl-yFfF7W5U/view?usp=sharing) from the potential vendor (s). Refer to the [Signature Authorization Matrix]({{< ref "authorization-matrix" >}}) for signing authority.
...
All vendors processing [Personal Data]({{< ref "data-classification-standard#data-classification-definitions" >}}) require a privacy review. A full privacy review is only required every 24-months, provided the Vendor completed a full and satisfactory privacy review during the prior procurement cycle. Please see the details of SLA and how to complete this process in our [Zip documentation section](#privacy-review4-14-days)
