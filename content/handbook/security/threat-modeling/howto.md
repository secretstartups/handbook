...
The [formal framework that GitLab uses is called PASTA]({{< ref "threat-modeling" >}}). This guide helps apply the PASTA principals in a lightweight manner to maximize their impact when followed by any GitLab team member.
