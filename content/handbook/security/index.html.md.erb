 ...
 * [Phishing](/handbook/security/security-assurance/governance/phishing.html#what-to-do-if-you-suspect-an-email-is-a-phishing-attack)

To contact for any other reason, see [Contacting the Team](/handbook/security/#-contacting-the-team) or [Engaging the Security On-Call](/handbook/security/security-operations/sirt/engaging-security-on-call.html).
...
1.  If you are unsure whether the text or email is legitimate, contact [Security](/handbook/security/) to review, and confirm via the #ceo Slack channel.
1.  If the email is determined to be fake, follow the instructions for [phishing attacks](/handbook/security/security-assurance/governance/phishing.html#what-to-do-if-you-suspect-an-email-is-a-phishing-attack) below.
...
1. Set up your [Okta](/handbook/business-technology/okta/) account at [https://gitlab.okta.com](https://gitlab.okta.com),
  ...
  setting up Okta, you'll need to establish a [strong password](/handbook/security/index.html#gitlab-password-guidelines)
...
1. Enable two-factor authentication (2FA) for every account that supports
  it using the most secure option available, as outlined in our [password standard](https://about.gitlab.com/handbook/security/password-standard.html#two-factor-authentication-mfa-or-2fa). This is required for
...
1. Set up a screen saver with **password lock** on your laptop with a timeout of 15 minutes or less. GitLab is currently utilizing [JAMF](/handbook/business-technology/team-member-enablement/onboarding-access-requests/endpoint-management/) for endpoint management and can assist with this step.
...
1. Enable automatic software updates for security patches. On macOS, this is
  ...
  my Mac up to date". GitLab is currently utilizing [JAMF](/handbook/business-technology/team-member-enablement/onboarding-access-requests/endpoint-management/) for endpoint management and can assist with this step.
...
* If your testing is frequent, configure the firewall to only allow the ports needed for your testing, and stay on an [isolated network](network-isolation/index.html) or use a [personal VPN](/handbook/tools-and-tips/personal-vpn/).
...
4. **Report** suspect situations to an officer of the company or use the [engage the Security Engineer on-call](/handbook/security/security-operations/sirt/engaging-security-on-call.html).
...
Passwords are one of the primary mechanisms that protect GitLab information systems and other resources from unauthorized use. Follow [GitLab's password guidelines](/handbook/security/password-guidelines.html) when constructing secure passwords and ensuring proper password management to keep GitLab secure. To learn what makes a password truly secure, read this [article](https://medium.com/peerio/how-to-build-a-billion-dollar-password-3d92568d9277) or watch this [conference presentation](https://www.youtube.com/watch?v=vudZnjp5Uq0&t=19183) on password strength.

### Panic Email

Should a team member lose a device such as a thumb drive, YubiKey, mobile phone, tablet, laptop, etc. that contains their credentials or other GitLab-sensitive data they should report the issue using the `/security` command in Slack to [engage SIRT](/handbook/security/security-operations/sirt/engaging-security-on-call.html#engage-the-security-engineer-on-call).
...
For more on personal VPNs see the [Personal VPN](/handbook/tools-and-tips/personal-vpn/) page.

### Other Security Topics

- [Security Team handbook](/handbook/security/)
...
- Secure the Product  - [Security Engineering Sub-department](/handbook/security/security-engineering/)
- Protect the Company - [Security Operations Sub-department](/handbook/security/security-operations/)
- Lead with Data      - [Threat Management Sub-department](/handbook/security/threat-management/)
- Assure the Customer - [Security Assurance Sub-department](/handbook/security/security-assurance/)
...
This topic is part of our [Engineering FY23 Direction](/handbook/engineering/#fy23-direction).
...
To help achieve the vision of transparently leading the world to secure outcomes, the Security Department has nominated a [Security Culture Committee](./security-culture.html).
...
<table id="Sub-Departments">
  <tr>
    <th>
        ...
        <h5><a href="https://about.gitlab.com/handbook/security/security-engineering/">Security Engineering</a></h5>

    </th>
    <th>
        <i class="fas fa-shield-alt i-bt"></i>
        <h5><a href="https://about.gitlab.com/handbook/security/security-operations/">Security Operations</a></h5>
    </th>
    <th>
        <i class="fas fa-bullseye i-bt"></i>
        <h5><a href="https://about.gitlab.com/handbook/security/threat-management/">Threat Management</a></h5>
    </th>
    <th>
        <i class="fas fa-hands-helping i-bt"></i>
        <h5><a href="https://about.gitlab.com/handbook/security/security-assurance/">Security Assurance</a></h5>
  ...
  <tr>
      <td>
        <ul>
            <li><a href="https://about.gitlab.com/handbook/security/security-engineering/application-security/">Application Security</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-engineering/infrastructure-security/">Infrastructure Security</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-engineering/security-logging/">Security Logging</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-engineering/automation/">Security Automation</a></li>
            <li>External Security Communications</li>
        </ul>
      </td>
      <td>
        <ul>
            <li><a href="https://about.gitlab.com/handbook/security/security-operations/sirt/">Security Incident Response Team (SIRT)</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-operations/trustandsafety/">Trust and Safety</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li><a href="https://about.gitlab.com/handbook/security/threat-management/red-team/">Red Team</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/threat-management/security-research/">Security Research</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/threat-management/vulnerability-management/">Security Threat & Vulnerability Management</a></li>
        </ul>
      </td>
      <td>
        <ul>
            <li><a href="https://about.gitlab.com/handbook/security/security-assurance/field-security/">Field Security</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-assurance/security-compliance/">Security Compliance, Commercial</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-assurance/dedicated-compliance/">Security Compliance, Dedicated Markets</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-assurance/governance/">Security Governance</a></li>
            <li><a href="https://about.gitlab.com/handbook/security/security-assurance/security-risk/">Security Risk</a></li>
        </ul>
      </td>
  </tr>
</table>
...
The [Security Logging team](/handbook/security/security-engineering/security-logging) is focused on guaranteeing that GitLab has the data coverage required to:
...
[Security Automation](/handbook/security/security-engineering/automation/) specialists help us scale by creating tools that perform common tasks automatically. Examples include building automated security issue triage and management, proactive vulnerability scanning, and defining security metrics for executive review. Initiatives for this specialty also include:
...
The [SIRT team](/handbook/security/security-operations/sirt) is here to manage security incidents across GitLab. These stem from events that originate from outside of our infrastructure, as well as those internal to GitLab. This is often a fast-paced and stressful environment where responding quickly and maintaining ones composure is critical.
...
[Trust & Safety](/handbook/security/security-operations/trustandsafety/) specialists investigate and mitigate the malicious use of our systems, which is defined under Section 3 of the [GitLab Website Terms of Use](/terms/#gitlab_com). This activity primarily originates from inside our infrastructure.
...
- Research and prevention of trending abuse methodologies.
 ...
 For more information please see our [Resources Section](/handbook/security/security-operations/trustandsafety/#trust--safety-resources)

<i>**Code of Conduct Violations**</i> are [handled](/handbook/marketing/developer-relations/workflows-tools/code-of-conduct-enforcement) by the [Developer Relations Team](/handbook/marketing/developer-relations/). For more information on reporting these violations please see the [GitLab Community Code of Conduct](/community/contribute/code-of-conduct/) page.

#### Lead with Data - The Threat Management Sub-department

[Threat Management Sub-department](/handbook/security/threat-management) teams are cross-functional. They are responsible for collaborating across the Security department to identify, communicate, and remediate threats or vulnerabilities that may impact GitLab, our Team Members or our users and the community at large.

##### Red Team

GitLab's internal [Red Team](/handbook/security/threat-management/red-team) emulates adversary activity to better GitLab’s enterprise and product security. This includes activities such as:
...
- Following [GitLab's responsible disclosure policy](/security/disclosure/#external) for third party disclosure
...
- Facilitating [Customer Assurance activities](/handbook/security/security-assurance/field-security/customer-security-assessment-process.html) including [The Trust Site](https://about.gitlab.com/security/) and [The Customer Assurance Package](/handbook/security/security-assurance/field-security/customer-assurance-package.html).
...
- Maintaining a certification [roadmap](https://gitlab.com/groups/gitlab-com/gl-security/compliance/-/roadmap) based on customer needs _e.g._
    - FedRAMP
    - ISO 27001
    - [SOC 2](/handbook/security/security-assurance/security-compliance/certifications.html)
- Monitoring the adequacy and effectiveness of [GitLab security common controls](/handbook/security/security-assurance/security-compliance/sec-controls.html) and timely remediation of observations
...
For additional information about the Security Compliance program see the [Security Compliance team handbook page](/handbook/security/security-assurance/security-compliance/) or refer to [GitLab's security controls](/handbook/security/security-assurance/security-compliance/sec-controls.html) for a detailed list of all compliance controls organized by control family.
...
- Maintaining a [Security Operational Risk Management program](/handbook/security/security-assurance/security-risk/storm-program/index.html), executing annual operational security risk assessments, and managing a consolidated security risk register.
- Maintaining a [Third Party Risk Management program](/handbook/security/security-assurance/security-risk/third-party-risk-management.html)
...
- [Security Architecture](/handbook/security/architecture/)
- [Security Architecture Review process](/handbook/security/architecture/review.html)
...
Please be aware that the Security Department can only be paged internally. If you are an external party, please proceed to [Vulnerability Reports and HackerOne](/handbook/security/#vulnerability-reports-and-hackerone) section of this page.

* Use the `/security` Slack command to be guided through a form that [engages the Security Engineer On-Call](https://about.gitlab.com/handbook/security/security-operations/sirt/engaging-security-on-call.html#engage-the-security-engineer-on-call)
* For general Q&A, GitLab Security is available in the `#security` channel in GitLab Slack.
* For [low severity](/handbook/security/security-operations/sirt/engaging-security-on-call.html#low-severity-issues), non-urgent issues, [SIRT](/handbook/security/security-operations/sirt) can be reached by mentioning `@sirt-members` in Slack or by opening an issue with `/security` in Slack. Please be advised the SLA for Slack mentions is 6 hours on business days.
...
Career opportunities at GitLab, personal growth, and development are important and encouraged. Security team members and managers are encouraged to use [Individual Development Plans](/handbook/security/individual-development-plan.html) to help foster, guide, and assist with career growth.
...
```mermaid
  ...
  click sec:sem "/job-families/security/security-leadership/#security-leadership-roles-at-gitlab";
  click sec:sms "/job-families/security/security-leadership/#senior-manager-security";
  click sec:ds "/job-families/security/security-leadership/#security-leadership-roles-at-gitlab";
```

#### Security Internship

For information on the security internship, see the [Internship page](/handbook/security/internship.html).
...
For more information, see the [Security Shadow Program](/handbook/security/security-shadow.html) page.
...
The [Secure Sub-Department](/handbook/engineering/development/sec/secure/) must not be mistaken with the Security Teams.
...
- [GitLab Information Security Management System](/handbook/security/ISMS.html)
- [GitLab Internal Acceptable Use Policy](/handbook/people-group/acceptable-use-policy/)
- [GitLab Password Standards](/handbook/security/password-standard.html)
...
- [Security Best Practices](/handbook/security/), using 1Password and similar tools, are documented
  on their own [security best practices page](/handbook/security/).
- [Secure Coding Training](./secure-coding-training.html).
...
This group is setup to help interested Security team members get up to speed with AI technologies and how to secure them. For more information, see the [AI in Security Learning Group page](/handbook/security/learning-group-ai.html).
...
the triage process:
    - [`~"type::bug"`, `~"type::maintenance"`, or `~"type::feature"` if appropriate](/handbook/security/security-engineering/application-security/vulnerability-management.html#vulnerability-vs-feature-vs-bug)
...
if and only if the issue is [determined to be a vulnerability](/handbook/security/security-engineering/application-security/vulnerability-management.html#vulnerability-vs-feature-vs-bug).
...
directly or through our [HackerOne Bug Bounty Program](/handbook/security/security-engineering/application-security/runbooks/hackerone-process.html).

Vulnerabilities must be mitigated and remediated according to specific timelines.
The timelines are specified in the [Vulnerability Management handbook](/handbook/security/threat-management/vulnerability-management/#remediation-slas) (a [controlled document](/handbook/security/controlled-document-procedure.html)).
...
a new `severity::2` `~security` issue is opened. It must be addressed in a security release [within 30 days](https://about.gitlab.com/handbook/security/threat-management/vulnerability-management/#remediation-slas),
...
1. Processing, storing, or transferring any kind of [RED or ORANGE data](/handbook/security/data-classification-standard.html)
...
* Touching cryptography functions, see the [GitLab Cryptography Standard](/handbook/security/cryptographic-standard.html) for more details
...
* A new feature that can manipulate or display sensitive data (i.e PII), see our [Data Classification Standard](/handbook/security/data-classification-standard.html) for more details
* Persisting sensitive data such as tokens, crypto keys, credentials, PII in temp storages/files/DB, manipulating or displaying sensitive data (i.e PII), see our [Data Classification Standard](/handbook/security/data-classification-standard.html) for more details
...
The current process for larger scale internal application security reviews be found [here](/handbook/security/security-engineering/application-security/appsec-reviews.html)
...
See the [dedicated page](/handbook/security/security-engineering/application-security/runbooks/triage-rotation.html) to read about our Triage Rotation process.

#### HackerOne Process

See the [dedicated page](/handbook/security/security-engineering/application-security/runbooks/hackerone-process.html) to read about our HackerOne process.

#### Security Dashboard Review

See the [dedicated page](/handbook/security/security-engineering/application-security/runbooks/security-dashboard-review.html) to read about our dashboard review process.
...
The GitLab issue should then be closed and - after 30 days - sanitized and made public. If the report was received via HackerOne, follow the [HackerOne process](/handbook/security/security-engineering/application-security/runbooks/hackerone-process.html#closing-out-and-disclosing-issues).
...
1. If an issue does not have `~keep confidential`, remove sensitive information from the description and comments, e.g.
   ...
   1. Information which our [Data Classification Standard](/handbook/security/data-classification-standard.html) and [SAFE framework](/handbook/legal/safe-framework/) say to not disclose
...
This does not apply to addressing security vulnerabilities or dependency updates, which have [separate processes for triage and patching](https://about.gitlab.com/handbook/security/#issue-triage).
...
Along with the internal security testing done by the [Application Security](#application-security), [Security Research](#security-research), and [Red](/handbook/security/threat-management/red-team/) teams, GitLab annually contracts a 3rd-party penetration test of our infrastructure. For more information on the goals of these exercises, please see our [Penetration Testing Policy](/handbook/security/penetration-testing-policy.html).
