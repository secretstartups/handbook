...
When doing this, create and link to a [single source of truth](https://about.gitlab.com/company/culture/all-remote/handbook-first/): ideally the [handbook](https://about.gitlab.com/handbook/handbook-usage/#why-handbook-first), otherwise an epic, issue, or Google Doc. The email or Slack message should not be the source of truth.
...
For all the same reasons that we want to [avoid direct messages](/handbook/communication/#avoid-direct-messages), [use public channels](/handbook/communication/#use-public-channels), and be [handbook-first](https://about.gitlab.com/company/culture/all-remote/handbook-first/), we track the % of messages that are not DMs.
