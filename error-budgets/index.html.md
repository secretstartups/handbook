...
|------------------|---------------------|---------------------|---------------------|
| Fulfillment:Provision, Fulfillment:Platform, Fulfillment:Biling and Subscription Management, Fulfillment:Commerce Integrations, Fulfillment:Purchase | 70% | Currently we are not able to analyze requests/metrics due to [this bug](https://gitlab.com/gitlab-org/customers-gitlab-com/-/issues/5119) that is actively worked on by Scalability. We'll then need time to investigate and fix the issues to be within budget |  2023-01-31 |
