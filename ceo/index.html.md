...
1. ***How scripted are interviews?*** Sid does well in unscripted interviews, but prefers questions outlined and attached in the [meeting invite](/company/culture/all-remote/live-doc-meetings/) in advance. Interviews tend to go well when it is clear ahead of time what the crux of the conversation will be about, and there is documented context which can be consumed asynchronously ahead of time. Below is an example.
   1. [GitLab Issue](https://gitlab.com/gitlab-com/people-group/learning-development/general/-/issues/23)
   1. Resulting [Google Doc agenda](https://docs.google.com/document/d/10xWzU0nTSsFiRFmEn6D6bKCZm-Y_Oa45u04MlvuGqmY/edit) with questions, prepared in advance and attached in the calendar invite (*visible to GitLab team members only*)
   1. Resulting [interview](https://youtu.be/7kMQj4O4ZGU) captured on GitLab Unfiltered (you can follow the flow by listening and referencing the above doc)
