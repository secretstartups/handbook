...
* Spending Plus/Minus 10% - Each e-group member will present a list of initiatives where they would spend additional budget dollars if made available and a list of items where they would make reductions if necessary. The amount of each list will equal 10% of the current quarter forecasted gross expenses. (1 hour)
