...
1. Help [AppSec](security/#application-security) [categorizing your new project](security/security-engineering-and-research/application-security/inventory.html#how-to-categorize-projects).
