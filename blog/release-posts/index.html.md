...
- Once all content is reviewed and complete, add the `Ready` label and assign
  ...
  **Important note on naming files**: PMs should create file names that are descriptive and have reasonable overlap with the title of the content block itself. This makes it easier to related content blocks to yml file by different participants in the review process.
  ...
  - Feature file names: feature-something-descriptive.yml (don't designate primary vs secondary as that can change)
...
- {:#application-screenshots} **Application screenshots**:
  ...
  feature is available. Minimize empty space in a screenshot.
...
When added to a markdown-supported entry, every [video should be wrapped into a figure tag](/handbook/markdown-guide/#videos), as shown below:
...
You can also watch [this video](https://about.gitlab.com/handbook/marketing/blog/release-posts/#release-post-item-generator) demonstrating how to use the `release post item generator`. 

*note: The release post item generator is still in beta. If you find issues or have questions post them in [#release-post-iteration](https://gitlab.slack.com/archives/CTXULEPQD)* or add them to the current cycle  release post retrospective issue.
