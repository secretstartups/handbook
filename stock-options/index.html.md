...
Standard Option Grants are broken out by level for each division. If you have any questions on what grant should be offered to a new hire, please reach out to the Total Rewards team by email to `total-rewards@ gitlab`.
...
grants are eligible to be considered for a refresh grant. The team member list is reviewed each quarter approximately one week before the Compensation Committee meeting (which is typically within a couple weeks of the board of directors meeting). Refresh grants are made
at the current [stock option grant levels](#stock-option-grant-levels) and vest
over 4 years with a one year cliff. Refresh grants will be adjusted to ensure the team member is aligned to the stock level as outlined in [Stock Option Grant Levels](#stock-option-grant-levels). The purpose of the refresh grant program is to ensure the team member is continually vesting in line with our benchmarks. If you received extra options in the past this will cause your refresh grant to be lower. For example, if you have been promoted in the last 12 months, the promotion grant would be offered based on the level prior to your promotion. All proposed grants are subject
...
**Note for US residents:** whichever method you choose, be sure to download the **83-b election form** provided by Carta and file with the IRS within 30 days of exercise. Send a copy of the signed and dated election form to `stockadmin@gitlab.com`. The Stock Plan Administrator will file it within Bamboo/HR.
...
If you have qustions about equity or the content in the Knowledge Assessment, please reach out to the Total Rewards team. If the quiz is not working or you have not recieved your certificate after passing the Knowledge Assessment, please reach out to the Learning & Development team at `learning@gitlab.com`.
