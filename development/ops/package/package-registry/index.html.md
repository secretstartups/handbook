...
title: Package Group - Package Registry
---
...
The recommended way to release the new Package Registry is using the support [statuses](https://about.gitlab.com/handbook/product/gitlab-the-product/#alpha-beta-ga).
...
This page should clearly state that the Package Registry is in Alpha state and thus, not ready for production use.
