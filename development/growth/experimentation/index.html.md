...
- GitLab `gitlab-org/gitlab` project
    ...
    - [Experiment rollout](https://gitlab.com/gitlab-org/gitlab/-/issues/new?issuable_template=experiment_rollout_template)
...
- Growth `team-tasks` project
    ...
    - [Experiment rollout](https://gitlab.com/gitlab-org/growth/team-tasks/-/issues/new?issuable_template=experiment_rollout_template) issue template for Growth groups
