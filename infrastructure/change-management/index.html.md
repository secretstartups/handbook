...
1. Major version upgrades (**major** definition following www.semver.org) of tooling (HAProxy, Chef and others).
...
1. Minor version upgrades (**minor** definition following semver.org) of tools or components (HAProxy, AlertManager and others).
