...
1. Open an [incident review](/handbook/engineering/infrastructure/incident-review) issue. Label it with the severity label appropriate to the incident it would have had, had the incident actually occurred. Label the incident review issue with the `~Near Miss` label.
