...
1. After the incident is resolved, the IMOC is responsible for updating the summary in the incident issue and conducting the [post-incident review](/handbook/engineering/infrastructure/incident-review).
