...
To setup JupyterLab for your @gitlab.com account, follow [these steps](https://gitlab.com/gitlab-data/data-science/-/tree/kevin-addl-config). Please note that these need to be completed before you follow instruction for JupyterLab:

1. Run your data onboarding script
2. Setup dbt profile 
3. Access Snowflake
4. Receive credentials to connect to Snowflake and add these to your dbt profile.
