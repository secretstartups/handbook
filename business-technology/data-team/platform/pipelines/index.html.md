...
Currently this tap only extracts a small number of objects from ZenGRC as a pilot for the data source. These are listed in the [stream types in `tap_zengrc/tap.py`](https://gitlab.com/gitlab-data/tap-zengrc/-/blob/main/tap_zengrc/tap.py#L20). 
