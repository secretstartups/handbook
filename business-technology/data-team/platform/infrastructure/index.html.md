...
Step 1:- Connect to Kubernetes pod `kubectl exec -ti <pod_name> -c <webserver|scheduler> /bin/bash` In our current setup kubectl exec -ti airflow-deployment-7484d899c6-tfm8v -c scheduler /bin/bash 
