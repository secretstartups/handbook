...
- The license is generated by our CustomersDot and the customer will be emailed a license key and the license will also be available in the CustomersDot application.
...
1. Navigate to the [CustomersDot](https://customers.gitlab.com/)
