...
- Need Access to [LicenseDot?](https://license.gitlab.com/)
    - to get a login to LicenseDot, [open an access request](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) and remove all systems in the list except for the row for `GitLab DEV` which you will use to OAuth into the application.
...
- [Quote Approval instruction](/handbook/business-technology/order-processing/#how-to-submit-a-quote-for-discount-and-payment-term-approval)
...
- The license is generated by our LicenseDot and the customer will be emailed a license key and the license will also be available in the CustomersDot application.
...
Self Service: LicenseDot

1. Navigate to the [LicenseDot](https://license.gitlab.com/)
