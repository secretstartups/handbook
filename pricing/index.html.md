...
We consider four key elements in our pricing methodology:

<img src="https://docs.google.com/drawings/d/e/2PACX-1vQ8dtPMDRuxgpAolc3hGxIVd2MuJ9juxY3p0jWyIUaF_zS9pLFYY8X76A1rcMMenUKU8u2D-C4Qo_JW/pub?w=499&amp;h=130">
...
1. Cross-team project management
1. Multiple Approval Rules
1. More control over your code
1. Multi-region support

Ultimate (all above AND):

1. Company-wide portfolio management
1. Advanced Application Security
...
1. This pricing approach aligns with our [Buyer Based Open Core model](/company/pricing/#buyer-based-open-core).
1. The list prices of our plans are blended prices with consideration for both developer and non-developer use cases.
1. We are [selling a suite](/company/pricing/#only-sell-a-suite) and taking care of specific non-developer use cases by making a discount conditional on not using part of the product.
...
1. More usage of all the products. => This is essential for us, due to our [seed then nurture](/strategy#seed-then-nurture) product strategy.
...
Our [three tiers](#three-tiers) are differentiated based on [the buyer persona](/handbook/marketing/strategic-marketing/roles-personas/#buyer-personas) or IC who buys GitLab, from individual contributor, to manager/director, to executive. Every person in the company [is on the same tier](/company/pricing/#single-plan-for-one-customer), even if they don't use all the features.
