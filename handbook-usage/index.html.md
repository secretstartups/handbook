...
1. When introducing a process change, not only should you contribute to the handbook by [making small merge requests](/handbook/values/#make-small-merge-requests), but you should also, when possible and feasible, introduce the process itself for adoption to its intended audience iteratively. We want to avoid significant process changes are are unnecessarily top-down, disruptive, and make no attempt at soliciting team member feedback. These types of process changes can disempower [DRIs](/handbook/people-group/directly-responsible-individuals/) (directly responsible individuals) and cause people to focus on process rather than results. 
...
- **Avoid unstructured content based on formats like [FAQs](https://idratherbewriting.com/2017/06/23/why-tech-writers-hate-faqs/), lists of links, resource pages, glossaries, courses, videos, tests, processes, standard operating procedure, training, or how-to's.**
...
1. Avoid merging your own merge request until at least one other team member has reviewed your MR, unless it's a normal part of your role (such as PMs updating direction pages).<br> 
