...
1. The CES will ask the candidate if they have any recommendations on how to make the adjustment(s). If none are provided they will work with the Recruiter and ask for assistance from the [Absence Management Team](/handbook/people-group/absence-management-team) at `leaves@gitlab.com` to arrange adjustment(s).
...
1. Do you require visa sponsorship or a work permit to work for GitLab? Or do you require the work permit to be transferred to GitLab? If the answer is yes, we will not be able to proceed, [unless you currently hold a work permit in the Netherlands](/handbook/people-group/visas/#dutch-work-permits). You can refer to this [page](/handbook/people-group/visas/) for further clarity
...
1. The candidate should always be notified if they've been rejected. The talent acquisition team is primarily responsible for declining the candidate, but the hiring manager should be prepared to let the candidate know why they were declined if they had progressed to the team or manager interviews. The hiring manager can also share this feedback with the talent acquisition team, who will relay it to the candidate.
