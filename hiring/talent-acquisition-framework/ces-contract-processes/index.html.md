...
| GitLab GK, Japan | Jess Dallmar, Rob Allen. Backups: Dale Brown, Craig Mestel | 
...
1. Check the candidate's background check in Sterling. If the order is still pending, contact the Senior Background Check Specialist advising them of the unhire so they can cancel any pending orders.
