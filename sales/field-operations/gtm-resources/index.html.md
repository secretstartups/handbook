...
1. Commercial Accounts: Mid-Market accounts are covered by three Sales motions: First Order (New Business) accounts, Key accounts, and Territory accounts:
    ...
    - **Key Accounts:** High potential accounts with an active subscription, that we're looking to grow and expand with deeper dedicated sales involvement and touch-points. These accounts are nominated through both quantitative & qualitative analysis in Annual Planning for their growth potential. In addition, all `First Order` accounts will be passed over as a `Key Account` once an initial deal is closed won. It's important this transition occurs in a timely manner after initial deal closure, to start business expansion efforts ASAP.
