...
For customers who are not exempt, the default values will be "Yes" for all fields. For customers who are exempt based on the [Availability Matrix](https://internal-handbook.gitlab.io/handbook/product/fulfillment/cloud-licensing/#availability-matrix), the default values will be "No" for all fields. 
...
- [Availability Matrix](https://internal-handbook.gitlab.io/handbook/product/fulfillment/cloud-licensing/#availability-matrix)
