...
|                                       |                                                              | `Default Bundle` (Admin role) | `SAL_Users` | `View_Group` | `TAM Journey Orchestrator` | `TAM_Users` |
| ------------------------------------- | ------------------------------------------------------------ | ----------------------------- | ----------- | ------------ | -------------------------- | ----------- |
...
| Journey Orchestrator (Admin)          | Administrative access to creating and deploying one-to-many email campaigns | ✓                             |             |              | ✓                          |             |
