...
5. Watching videos is core to your onboarding. You can watch YouTube & Chorus videos at 1.5x or 1.75x speed to get through them efficiently, you can still retain the information but in less time. Go to the Settings widget > Playback speed.

6. When you first start, searching through Slack is a great way to find useful information as it's our primary method of asking questions and announcing things to the company. Some channels that are particularly good for information:

[#questions](https://gitlab.slack.com/archives/C0AR2KW4B)<br>
[#smb](https://gitlab.slack.com/archives/CH4KPGS87)<br>
[#sales](https://gitlab.slack.com/archives/C02NE5PQM)<br>
[#smb_amer](https://gitlab.slack.com/archives/C010YDVD1BP)<br>
[#international-smb](https://gitlab.slack.com/archives/CN84VB75H)<br>
[#smb_training_support](https://gitlab.slack.com/archives/CKYLWKGJU)<br>
...
10. Make sure your calendar is always up to date so that you can get meetings from SDRs without having to moving them around.

11. Listen to as many [Chorus](https://chorus.ai/) calls as possible. We only record calls with the customer's permission in the US, but they are an excellent way to onboard even if you are not based in the US yourself.

12. Add your own tips to this page as you onboard to pay it forward for the next new rep!
...
3. Ensure "Next Steps," "Next Step Date," and "Next Steps Owner" are current with actionable and informative information that helps guide you on how to move the opportunity through the pipeline
...
6. Building your [custom deck](https://docs.google.com/presentation/d/1duy8kjEvNiRx8fnCvc6ZnxWwXTM_71phbG3k9rgmU4Q/edit?usp=sharing) for any opp amount over $10k amount (n.b. amount, not iACV) that:
...
2. **Calculated ROI of GitLab v. Next Best Option** 
...
3. **Two options (rough plans) with GitLab going forward**
...
4. **Non-Custom Single Application pitch to the customer**
...
5. **Full capture of the customer's feedback on the 'Single Application' slide**
