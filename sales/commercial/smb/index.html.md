...
1. Finally you will use the following equations to get yuour 50/50, best case, and commit number to forecast, all using Gross iACV as the renewal loss will be calculated into this equation based on the input in Clari
