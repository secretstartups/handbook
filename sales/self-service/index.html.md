...
| :--------------- | :----------------- | :----------------- | 
| Fulfillment | [Analytics Instrumentation](https://about.gitlab.com/handbook/product/analytics-instrumentation-guide/) | The Self-Service Team works with the product intelligence team in cases where our product data set is incomplete (i.e. instrumentation gaps, accessibility, accuracy) when the Self-Service Team team is attempting to answer product questions related to self-service. | 
