...
Sales Leadership primarily [uses Clari to understand opportunities](#advantages-to-updating-opps-in-clari). Other GitLab Team Members with SFDC access should use the following resources to understand a Sales opportunity.
- The [opportunity](/handbook/sales/field-operations/gtm-resources/#opportunities) (if available [Command Plans](#opportunity-management-requirements) or existing customer [Success Plans](/handbook/customer-success/tam/success-plans/) offer great overviews)
