...
* [We don't support multiple types of users on one deployment](/handbook/ceo/pricing/#single-plan-for-one-customer) because it would make a bad experience.  We also don't split the servers for the same reason.  Our job is to make the customer successful and splitting the deployment is not the path to success.
