...
* In case of a new hire in Enterprise, Commercial, or Channel Sales, [$1,000]((/handbook/total-rewards/compensation/#exchange-rates)) add-on referral bonus is applicable only if the `Sales Regional Factor` is less than 0.65. 
