...
* [$1,500](/handbook/total-rewards/compensation/#exchange-rates) add-on referral bonus for any [NQR](/handbook/sales/commissions/#quotas-overview) new hire. This is a temporary referral add-on campaign that will be availabe for candidates with a hire date of 2020-11-01 until 2020-02-01. Hire date is defined as the date that the candidate was set to hired. This will be confirmed to the referer by the recruiter for the role. 
