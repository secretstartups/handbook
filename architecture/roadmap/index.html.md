...
Finally, we must be able to quantify risk, and, in doing so, further quantify how much we are willing to accept. Error budgets provide a framework to do this, and an organizational adherece to error budgets enables us to think about the steps we need to take organizationally to handle what happen after error budgets have been depleted. Thus, we must deliver on a full technical and organizational implementatioon of error budgets.
