...
### If an exception is requested due to a customer hardship, please complete the [Travel Exception Form](https://docs.google.com/forms/d/e/1FAIpQLSe_FDsWXyOr0gFlKw_jTJwlElBHaS0b7bSTKQsch6sgyYUvOA/viewform?vc=0&c=0&w=1&flr=0).  Each request must be routed first for approval by a Senior Leader (Sr. Director/VP) within your function who must forward the request to the e-Group member.  The e-Group member will present the request to the COVID-19 Working Group for final approval.   

If an exception is requested due to a customer hardship, please complete the Travel Exception Form.  Each request must be routed first for approval by a Senior Leader (Sr. Director/VP) within your function who must forward the request to the e-Group member.  The e-Group member will present the request to the Covid-19 Travel Working Group for final approval.  
