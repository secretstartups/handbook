...
It is easy to prioritize consistency over efficiency, because consistency can be easier to define and identify. We should be careful when optimizing for consistency. We should also take a company-wide lens when evaluating changes to ensure that they will improve efficiency for GitLab as a whole.
