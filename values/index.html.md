...
It is easy to prioritize consistency for efficiency, because consistency can be easier to define and identify. We should be careful when optimizing for consistency, instead, take a company-wide lens to evaluate whether the changes would improve efficiency for GitLab as a whole.
