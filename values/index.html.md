...
{:.no_toc}
Every dollar we spend will have to be earned back. Be as frugal with company money as you are with your own. In saying this, we ask team members to weigh the cost of purchases against the value that they will bring to the company. This sub-value should not be taken out of context. There are times and situations in which we know that folks may choose to spend beyond their normal spend levels--think of a honeymoon trip or special hobby purchase. We instead ask you to use the lens of a GitLab team member who considers the degree to which a purchase increases their ability to better accomplish their work and achieve business [results](/handbook/values/#results) relative to cost. We have [guidelines](/handbook/spending-company-money/#guidelines) around this sub-value to help team members better understand our expensing process and expectations.
