...
1. Financial information, including revenue and costs for the company, is confidential because we plan to be a public company and, as such, need to limit both the timing and content of financial information as investors will use and rely on it as they trade in GitLab stock. As the guideline, if it is a first step to constructing a profit, we need to keep it confidential. Examples include:
   ...
   1. Timing and plans for [becoming a public company](/handbook/being-a-public-company/). In addition to the items outlined under [Public Company Readiness](https://about.gitlab.com/handbook/being-a-public-company/#public-company-readiness), the receptivity of the market to a software offering is a key consideration and it is difficult to predict when these factors will align. A firm date or window will be established after [Form S-1 Registration Statement](https://www.investopedia.com/terms/s/sec-form-s-1.asp) is publicly filed.
