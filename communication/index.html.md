...
1. Financial information, including revenue and costs for the company, is confidential because we plan to be a public company and, as such, need to limit both the timing and content of financial information as investors will use and rely on it as they trade in GitLab stock. As the guideline, if it is a first step to constructing a profit, we need to keep it confidential. Examples include:
   ...
   1. Timing and plans for [becoming a public company](/handbook/being-a-public-company/). In order to ensure a successful offering, we need to demonstrate the ability to deliver to plan across all departments for several quarters before proposing a motion to the Board. A second factor is the receptivity of the market to a high growth, software offering.  It is very difficult to predict when these two factors will align. An actual date or window is speculative until we publicly file a document with the SEC called a Form S-1 Registration Statement. The S-1 can take weeks to months to complete where by market conditions may shift and warrant a wait-and-see approach.
