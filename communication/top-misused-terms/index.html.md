...
1. White-collar/Blue-collar workers - Use knowledge worker/trade worker instead, the origional terms are outdated references and have socioeconomic connotations. There are also other [color classifications](https://en.wikipedia.org/wiki/Designation_of_workers_by_collar_color) that are less common.
