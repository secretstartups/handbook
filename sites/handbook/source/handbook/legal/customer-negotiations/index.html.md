...
1. When asking questions about data privacy, Customers may also raise questions about security. Generally, such questions are best directed to the [Field Security Team](https://about.gitlab.comhandbook/engineering/security/security-assurance/field-security/#contact-the-field-security-team). However, the following resources may be useful in the first instance:
    ...
    - GitLab's [Customer Assurance Package](https://about.gitlab.comhandbook/engineering/security/security-assurance/field-security/customer-assurance-package.html) provides details of GitLab's current Security and Compliance posture.
