...
- You have the right to know whether your Personal Information is sold or shared and to opt-out of the sale of your Personal Information. You may opt-out of interest-based advertising based on your browser by exercising the<!-- OneTrust Cookies Settings button start -->
<button id="ot-sdk-btn" class="ot-sdk-show-settings" style="padding: 5px 5px: font-size: 8px:">Do Not Sell or Share My Personal Information</button> <!-- OneTrust Cookies Settings button end --> link in the footer of our sites. You may exercise all other California rights as described in the [Rights and Choices](https://about.gitlab.com/privacy/#what-are-my-rights-and-choices-regarding-personal-data) section of the GitLab Privacy Statement; and
...
To opt out from targeted advertising, click on the <!-- OneTrust Cookies Settings button start --> <button id="ot-sdk-btn" class="ot-sdk-show-settings" type="button" style="padding: 5px 8px; font-size: 10px;">Cookie Preferences</button> <!-- OneTrust Cookies Settings button end --> link in the footer of each of our website pages under "Contact Us". An opt-out request will be specific to the device and browser you are using. Therefore you will need to opt-out from each browser that you use to access GitLab websites and services.
