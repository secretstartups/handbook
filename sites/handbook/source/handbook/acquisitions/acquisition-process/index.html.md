...
1. Share call summary ([Initial Acquisition Review Template](https://docs.google.com/document/d/1RekjfQj89pIV7DZzeNZ00HYOwqlqlDFm7Gy4yZET9rc/edit?usp=sharing), a GitLab internal document) of companies that are aligned with GitLab's acquisition strategy ("Qualified Pipeline") with relevant product lead.
    - Create a new, private Slack channel (format: `#acq-company_name`) and add the internal GitLab document to the top. Add CProdO, VP of Product Management, and the relevant product and engineering leaders to help with the initial assessment of the opportunity.
...
1. Presenting the business case for approvals (by order of occurrence):
    ...
    1. Functional approvals: The corporate development acquisition lead, Product and Engineering champions will present the business case for acquisition to the CProdO, VP of Product Management and CTO. They will review to approve the items listed in the Champions' approval (complete: executive summary, business case, term sheet)
...
1. Term Sheet:
    ...
    1. Once all approvals have been obtained, the corporate development acquisition lead will stage the term sheet for signing on Docusign for target CEO and GitLab CEO (in that order). Add CLO, CFO,  CProdO and VP of Product Management on Cc on the agreement.
        1. Approval tracking will be tracked on the term sheet approval issue mentioned earlier. Any changes to previously-approved terms need to be reviewed and approved once more by the following: Product champion, Engineering champion, VP of Product Management, CProdO, CTO, CLO, CFO, CEO. The changes should be referenced on the term sheet approval tracking issue _before_ seeking approvals.
