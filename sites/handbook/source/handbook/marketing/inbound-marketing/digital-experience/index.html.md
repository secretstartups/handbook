...
1. **Results** We focus on results (something about keep it simple, measurement)
    1. **Actionable**
    1. **Measurable**
1. **Iteration** When applying the [MVC](https://about.gitlab.com/handbook/product/product-principles/#the-minimal-viable-change-mvc) approach, make things smaller by reducing the scope of the job-to-be-done rather than sacrificing the end goal.
