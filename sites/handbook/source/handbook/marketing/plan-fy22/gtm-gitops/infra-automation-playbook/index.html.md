...
1. Understand their technical requirements: do their applications require a hybrid cloud infrastructure or multi-cloud? do they have any hard-dependencies on any infrastructure-as-code tool? do they need GitOps for K8s, non-K8s or both? In the case of K8s, are their clusters available outside their firewall?
