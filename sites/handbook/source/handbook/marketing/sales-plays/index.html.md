...
| Infrastructure Automation (GitOps) | primarily ENT; First Order and Growth | organizations that want to increase the elasticity and scale of their IT infrastructure via a prescriptive workflow for using Infrastructure as Code | CIO or VP of IT; VP of IT Infrastructure; VP of Platform Engineering |
...
| Digital Transformation / DevOps Platform | ENT and COM; First Order and Growth | organizations that want to accelerate the speed and improve the visibility of application development and delivery supporting broader digital transformation initiative(s) | Economic buyers and technical influencers |
