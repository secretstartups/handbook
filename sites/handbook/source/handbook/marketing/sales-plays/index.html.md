...
| [Atlassian Server EOL](/handbook/marketing/sales-plays/atlassian-eol/) | ENT and COM; First Order and Growth | organizations who would like to re-evaluate their SDLC toolchain based on Atlassian's announcement that they are ending support for Atlassian server products | CIO; App Dev Exec/Director/Manager |
...
| [Digital Transformation / DevOps Platform](/handbook/source/handbook/marketing/strategic-marketing/usecase-gtm/devops-platform/) | ENT and COM; First Order and Growth | organizations that want to accelerate the speed and improve the visibility of application development and delivery supporting broader digital transformation initiative(s) | Economic buyers and technical influencers |
