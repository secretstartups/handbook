...
There are certain occassions when a workshop needs to urgently be rescheduled due to technical difficulties. These are the directions to follow to send out a bulk notification to registrants about the disruption and reschedule date. If you run into any problems, please [open an issue](/handbook/marketing/marketing-operations/#-how-to-get-help) with the Marketing Ops team, and for urgent issues also include the issue in the slack chanel `#mktgops`.
