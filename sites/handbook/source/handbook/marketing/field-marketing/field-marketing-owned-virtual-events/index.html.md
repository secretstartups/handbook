...
1. Re-open your Marketo LP issue and request Verticurl close the LP and specify that the event has been cancelled. If this is an urgent request after-hours, please utilize [these instructions](/handbook/marketing/revenue-marketing/field-marketing/field-marketing-owned-virtual-events/#closing-a-webcast-landing-page) to close a `webcast LP` and [these instructions](/handbook/marketing/revenue-marketing/field-marketing/field-marketing-owned-virtual-events/#instructions-for-closing-registration) to close a `workshop LP`. 
...
1. Pre-Event and Post- Event Surveys
   - We utilize [these standard pre-event surveys](/handbook/marketing/revenue-marketing/field-marketing/field-marketing-owned-virtual-events/#zoom-confirmation-email) for each existing workshop type. These are the surveys that are linked in the Marketo templates and will added to the Zoom setup by the FMC. 
