...
Automation that opens a merge request in projects under `gitlab-org` shall apply the `~"automation:bot"` label for clearer measurements for bot authored MRs that may cause an impact to Engineering PIs. 
