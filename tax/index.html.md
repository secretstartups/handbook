...
**Sales revenue** from certain [territories](/handbook/business-technology/) where GitLab is active, can also lead to a demand from the business to establish an entity. A clear reason from tax risk management is to prevent that GitLab runs a permanent establishment risk in any of the territories.
