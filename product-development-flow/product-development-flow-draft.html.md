...
This phase begins after work has been broken down in Phase 1. PMs will apply the `workflow::ready for development` along with a milestone indicating an issue is to be prioritized for the upcoming milestone. Engineering will apply `Deliverable` signaling acceptance of the issue. This process occurs at the [beginning of milestone planning](https://about.gitlab.com/handbook/engineering/workflow/#product-development-timeline).
