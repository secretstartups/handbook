...
|<i class="fab fa-gitlab fa-fw" style="color:rgb(252,109,38); font-size:1.25em" aria-hidden="true"></i> **Defined Quality Plan** - Involving SETs in this phase ensures they are able to understand and effectively plan their own capacity before engineering is truly underway.| - [Quad Planning](/handbook/engineering/quality/qe-subdept/quad-planning/)<br>- [Test planning](/handbook/engineering/quality/qe-subdept/test-engineering/#test-planning) 	| - Software Engineer in Test |
...
|<i class="fab fa-gitlab fa-fw" style="color:rgb(252,109,38); font-size:1.25em" aria-hidden="true"></i> `workflow::awaiting security release` | Applied by an engineer after the issue has passed  verification , this label signals that it is ready but awaiting the next [monthly security release](/handbook/engineering/security/#timing-of-the-monthly-security-release).|
...
When an issue is in development the Software Engineer in Test ([SET](https://about.gitlab.com/handbook/engineering/quality/qe-subdept/#stable-counterparts)) will ensure the [quad planning](https://about.gitlab.com/handbook/engineering/quality/qe-subdept/quad-planning/#process) process is being followed regarding test plans, regression jobs, end to end tests, etc. Coordination is key between the assigned development engineer and the SET during this phase.
