...
When validating potential new features, in addition to seeking input from external customers, it's important to gather feedback from [internal customers](handbook/product/product-processes/#internal-customer-dris) listed on the Product Categories page. Internal customers are a great resource to help quickly validate a problem and brainstorm possible solutions. Engaging internal customers early on in the product development flow ensures their needs are considered up front, making it easier for them to use the feature more heavily as part of [Dogfooding](handbook/product/product-processes/#dogfood-everything). Significant internal usage of a feature helps accelerate the feature's maturity leading to [better results for external customers](handbook/values/#customer-results). For example, [Global Search](gitlab-org&153) and Geo(https://about.gitlab.com/blog/2020/04/16/geo-is-available-on-staging-for-gitlab-com/) are two features that have benefited from internal Dogfooding before being released to customers. If the initial conversation with internal customers is skipped, it may be more difficult for internal teams to incorporate the feature into their workflows once the feature becomes more mature. PMs are encouraged to open up [Dogfooding issues](handbook/product/product-processes/#dogfooding-process) during the validation phase to capture feedback received in initial conversations with internal customers. Even if you choose not to move forward with the feature, having an historical record of the feedback documented in the Dogfooding issue will be beneficial in case the feature is considered again at a later point.
