...
|<i class="fab fa-gitlab fa-fw" style="color:rgb(252,109,38); font-size:1.25em" aria-hidden="true"></i> **Defined Quality Plan** - Involving SETs in this phase ensures they are able to understand and effectively plan their own capacity before engineering is truly underway.| - [Quad Planning](/handbook/engineering/quality/quality-engineering-sub-department/quad-planning/)<br>- [Test planning](/handbook/engineering/quality/quality-engineering-sub-department/test-engineering/#test-planning) 	| - Software Engineer in Test |
