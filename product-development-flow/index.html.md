...
|<i class="fab fa-gitlab fa-fw" style="color:rgb(252,109,38); font-size:1.25em" aria-hidden="true"></i> `workflow::awaiting security release` | Applied by an engineer fter the issue has passed  verification , this label signals that it is ready but awaiting the next [monthly security release](/handbook/engineering/security/#timing-of-the-monthly-security-release).|
