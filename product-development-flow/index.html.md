...
When validating potential new features, in addition to seeking input from external customers, it's important to gather feedback from [internal customers](handbook/product/product-processes/#internal-customer-dris), who can help validate a problem and brainstorm possible solutions. Engaging internal customers early on in the product development flow ensures their needs are considered up front leading to better [Dogfooding](handbook/product/product-processes/#dogfood-everything) outcomes. Internal usage of a feature helps accelerate the feature's maturity, which leads to [better results for external customers](handbook/values/#customer-results) as was the case with [Global Search](gitlab-org&153) and [Geo](https://about.gitlab.com/blog/2020/04/16/geo-is-available-on-staging-for-gitlab-com/). If initial conversations with internal customers are skipped, it may be more difficult for internal teams to provide useful feedback as the feature matures. PMs are encouraged to open up [Dogfooding issues](handbook/product/product-processes/#dogfooding-process) during the validation phase to document the needs of internal customers to help inform future iteations of a feature, post-MVC.
