...
When validating potential new features, in addition to seeking input from external customers, it's important to gather feedback from [internal customers](handbook/product/product-processes/#internal-customer-dris) listed on the Product Categories page. Internal customers are a great resource to help quickly validate a problem and brainstorm possible solutions. Engaging internal customers early on in the product development flow ensures their needs are considered, thereby increasing the likelihood of internal teams using the feature later on as part of [Dogfooding](handbook/product/product-processes/#dogfood-everything). This leads to [better results for our external customers](handbook/values/#customer-results) as we see that features that have been Dogfooded are more successful than those that have not. If this initial conversation is skipped, it may be more difficult to for interal teams to incorporate the feature into their workflows as the feature matures.
