...
Our Mission is on a 30 year [cadence](/company/cadence/#mission). Our [Vision](/company/vision/) is on a 10 year cadence. Our [strategy](/company/strategy/) is on a 3-year cadence.
...
We firmly adhere to laws [including trade compliance laws](https://ir.gitlab.com/static-files/7d8c7eb3-cb17-4d68-a607-1b7a1fa1c95d#vii-compliance-with-all-laws-rules-and-regulations) in countries where we do business, and welcome everyone abiding by those legal restrictions to be customers of GitLab. In some circumstances, we may opt to not work with particular organizations, on a case-by-case basis. Some reasons we may choose not to work with certain entities include, but are not limited to:
