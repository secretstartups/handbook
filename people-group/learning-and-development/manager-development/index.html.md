...
The GitLab Learning & Development runs a quarterly [manager enablement program](https://about.gitlab.com/handbook/people-group/learning-and-development/manager-challenge/) to equip new and exisiting managers with a set of skills to managing all-remote teams. The program covers foundational management practices. One of the key benefits of the program is network and social learning. You will learn from other managers and build a sense of community across people leaders in the organization. Sign-up for the next cohort! 
