...
1. **Tool:** the recording will be done in Zoom. 
   ...
   - Once you are done recording, you can either hit Pause or Stop recording or just end the meeting. (Note: I can snip pieces of the video so if you start recording and then not start talking for 30+ seconds, I can snip that from the recording (same for any blank time at the end). 
