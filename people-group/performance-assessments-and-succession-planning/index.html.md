...
| **Performance at expectations** | With coaching, could progress within same level; focus on stretch goals for this team member. | May be considered for job enlargement at the same level but may need coaching in several areas, including people management. | Current role may still provide opportunity for growth/ development; focused on tactical; focus should helping improve strategic thinking.  |
| **Underperformance** | May be a candidate for reassignment, reclassification to a lower level or exit the organization.  | Effective performer, but may have reached career potential; try coach team member on becoming more innovative and focus on lateral thinking. | Experienced high performer but reached limit in career potential. Still a valueable team member and can be encouraged to develop communications and delegation skils. |
| Performance ↑ Potential → <b> | **Low Potential** | **Medium potential**| **High Potential**|
