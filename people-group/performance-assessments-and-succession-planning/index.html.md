...
| **Underperformance** | May be a candidate for reassignment, reclassification to a lower level or exit the organization.  | Effective performer, but may have reached career potential; try coach employee on becoming more innovative and focus on lateral thinking. | Experienced high performer but reached limit in career potential. Still a valueable team member and can be encouraged to develop communications and delegation skils. |
| Performance ↑ Potential → <b> | **Low Potential** | **Medium potential**| **High Potential**|
