...
Security reserves the right to execute security reviews against this software and dissallow use if they do not meet GitLab's [security and privacy](handbook/engineering/security/security-assurance/field-security/third-party-minimum-security-standards.html) expectations. 
