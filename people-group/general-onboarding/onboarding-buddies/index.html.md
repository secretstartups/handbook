...
1. **Suggest helpful handbook pages.** Chances are that you've discovered some particularly helpful pages in the handbook during your time at GitLab. Point them out to the new GitLab team-member, and help them get used to navigating the handbook. Some examples might include:
   ...
   - [The team page](https://about.gitlab.com/company/team/) that feeds into the un-audited [internal-only org chart](https://comp-calculator.gitlab.net/org_chart)
   - [The true Org chart](https://gitlab.bamboohr.com/employees/orgchart.php) in BambooHR, which is our SSoT for organizational structure
