...
1. ***TMR***: The Team Member Relations partner assigned to the particular offboarding case at hand should select the appropriate severance template. Options include: Non-California over 40, California over 40, Non-California under 40, California under 40. 
1. ***TMR***: The TMR should make a copy of the template and save it in the `Copies of Individual Severance Agreements` folder. 
1. ***TMR***: The TMR should fill out the document. 
1. ***TMR***: The TMR will ping the stock team in the stock option section of the document. 
1. ***TMR***: The TMR will share with the PBP and Legal for final review/approval. 
